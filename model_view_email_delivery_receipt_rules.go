...
// checks if the ViewEmailDeliveryReceiptRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailDeliveryReceiptRules{}

// ViewEmailDeliveryReceiptRules struct for ViewEmailDeliveryReceiptRules
type ViewEmailDeliveryReceiptRules struct {
	...
	Data *ViewEmailDeliveryReceiptRulesData `json:"data,omitempty"`
}
...
func NewViewEmailDeliveryReceiptRules() *ViewEmailDeliveryReceiptRules {
	this := ViewEmailDeliveryReceiptRules{}
	return &this
}
...
func (o *ViewEmailDeliveryReceiptRules) GetData() ViewEmailDeliveryReceiptRulesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewEmailDeliveryReceiptRulesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewEmailDeliveryReceiptRulesData and assigns it to the Data field.
func (o *ViewEmailDeliveryReceiptRules) SetData(v ViewEmailDeliveryReceiptRulesData) {
	o.Data = &v
}

func (o ViewEmailDeliveryReceiptRules) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailDeliveryReceiptRules) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailDeliveryReceiptRules struct {
	value *ViewEmailDeliveryReceiptRules
	isSet bool
}

func (v NullableViewEmailDeliveryReceiptRules) Get() *ViewEmailDeliveryReceiptRules {
	return v.value
}

func (v *NullableViewEmailDeliveryReceiptRules) Set(val *ViewEmailDeliveryReceiptRules) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailDeliveryReceiptRules) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailDeliveryReceiptRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailDeliveryReceiptRules(val *ViewEmailDeliveryReceiptRules) *NullableViewEmailDeliveryReceiptRules {
	return &NullableViewEmailDeliveryReceiptRules{value: val, isSet: true}
}

func (v NullableViewEmailDeliveryReceiptRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailDeliveryReceiptRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
