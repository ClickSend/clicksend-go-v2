...
// checks if the ViewSmsStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsStatistics{}

// ViewSmsStatistics struct for ViewSmsStatistics
type ViewSmsStatistics struct {
	...
	Data *ViewSmsStatisticsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewSmsStatisticsData and assigns it to the Data field.
func (o *ViewSmsStatistics) SetData(v ViewSmsStatisticsData) {
	o.Data = &v
}

func (o ViewSmsStatistics) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsStatistics) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsStatistics struct {
	value *ViewSmsStatistics
	isSet bool
}

func (v NullableViewSmsStatistics) Get() *ViewSmsStatistics {
	return v.value
}

func (v *NullableViewSmsStatistics) Set(val *ViewSmsStatistics) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsStatistics) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsStatistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsStatistics(val *ViewSmsStatistics) *NullableViewSmsStatistics {
	return &NullableViewSmsStatistics{value: val, isSet: true}
}

func (v NullableViewSmsStatistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsStatistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
