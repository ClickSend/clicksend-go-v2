...
// checks if the SendVoiceMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendVoiceMessage{}

// SendVoiceMessage struct for SendVoiceMessage
...
func (o SendVoiceMessage) MarshalJSON() ([]byte, error) {
...
func (o SendVoiceMessage) ToMap() (map[string]interface{}, error) {
...
type NullableSendVoiceMessage struct {
	value *SendVoiceMessage
	isSet bool
}

func (v NullableSendVoiceMessage) Get() *SendVoiceMessage {
	return v.value
}

func (v *NullableSendVoiceMessage) Set(val *SendVoiceMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableSendVoiceMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableSendVoiceMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendVoiceMessage(val *SendVoiceMessage) *NullableSendVoiceMessage {
	return &NullableSendVoiceMessage{value: val, isSet: true}
}

func (v NullableSendVoiceMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendVoiceMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
