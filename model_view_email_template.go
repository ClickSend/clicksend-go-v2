...
// checks if the ViewEmailTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailTemplate{}

// ViewEmailTemplate struct for ViewEmailTemplate
type ViewEmailTemplate struct {
	...
	Data *UserEmailTemplate `json:"data,omitempty"`
}
...
// SetData gets a reference to the given UserEmailTemplate and assigns it to the Data field.
func (o *ViewEmailTemplate) SetData(v UserEmailTemplate) {
	o.Data = &v
}

func (o ViewEmailTemplate) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailTemplate struct {
	value *ViewEmailTemplate
	isSet bool
}

func (v NullableViewEmailTemplate) Get() *ViewEmailTemplate {
	return v.value
}

func (v *NullableViewEmailTemplate) Set(val *ViewEmailTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailTemplate(val *ViewEmailTemplate) *NullableViewEmailTemplate {
	return &NullableViewEmailTemplate{value: val, isSet: true}
}

func (v NullableViewEmailTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
