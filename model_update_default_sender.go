...
// checks if the UpdateDefaultSender type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDefaultSender{}

// UpdateDefaultSender struct for UpdateDefaultSender
type UpdateDefaultSender struct {
...
type _UpdateDefaultSender UpdateDefaultSender
...
func (o UpdateDefaultSender) MarshalJSON() ([]byte, error) {
...
func (o UpdateDefaultSender) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateDefaultSender) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDefaultSender := _UpdateDefaultSender{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDefaultSender)

	if err != nil {
		return err
	}

	*o = UpdateDefaultSender(varUpdateDefaultSender)

	return err
}

type NullableUpdateDefaultSender struct {
	value *UpdateDefaultSender
	isSet bool
}

func (v NullableUpdateDefaultSender) Get() *UpdateDefaultSender {
	return v.value
}

func (v *NullableUpdateDefaultSender) Set(val *UpdateDefaultSender) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDefaultSender) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDefaultSender) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDefaultSender(val *UpdateDefaultSender) *NullableUpdateDefaultSender {
	return &NullableUpdateDefaultSender{value: val, isSet: true}
}

func (v NullableUpdateDefaultSender) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDefaultSender) UnmarshalJSON(src []byte) error {
	v.isSet = true
