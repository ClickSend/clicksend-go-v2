...
// checks if the ViewASpecificInboundSmsMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewASpecificInboundSmsMessage{}

// ViewASpecificInboundSmsMessage struct for ViewASpecificInboundSmsMessage
type ViewASpecificInboundSmsMessage struct {
	...
	Data *InboundSms `json:"data,omitempty"`
}
...
func NewViewASpecificInboundSmsMessage() *ViewASpecificInboundSmsMessage {
	this := ViewASpecificInboundSmsMessage{}
	return &this
}
...
// SetData gets a reference to the given InboundSms and assigns it to the Data field.
func (o *ViewASpecificInboundSmsMessage) SetData(v InboundSms) {
	o.Data = &v
}

func (o ViewASpecificInboundSmsMessage) MarshalJSON() ([]byte, error) {
...
func (o ViewASpecificInboundSmsMessage) ToMap() (map[string]interface{}, error) {
...
type NullableViewASpecificInboundSmsMessage struct {
	value *ViewASpecificInboundSmsMessage
	isSet bool
}

func (v NullableViewASpecificInboundSmsMessage) Get() *ViewASpecificInboundSmsMessage {
	return v.value
}

func (v *NullableViewASpecificInboundSmsMessage) Set(val *ViewASpecificInboundSmsMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableViewASpecificInboundSmsMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableViewASpecificInboundSmsMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewASpecificInboundSmsMessage(val *ViewASpecificInboundSmsMessage) *NullableViewASpecificInboundSmsMessage {
	return &NullableViewASpecificInboundSmsMessage{value: val, isSet: true}
}

func (v NullableViewASpecificInboundSmsMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewASpecificInboundSmsMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
