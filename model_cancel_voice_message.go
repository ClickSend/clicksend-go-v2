...
// checks if the CancelVoiceMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelVoiceMessage{}

// CancelVoiceMessage struct for CancelVoiceMessage
type CancelVoiceMessage struct {
...
func (o CancelVoiceMessage) MarshalJSON() ([]byte, error) {
...
func (o CancelVoiceMessage) ToMap() (map[string]interface{}, error) {
...
type NullableCancelVoiceMessage struct {
	value *CancelVoiceMessage
	isSet bool
}

func (v NullableCancelVoiceMessage) Get() *CancelVoiceMessage {
	return v.value
}

func (v *NullableCancelVoiceMessage) Set(val *CancelVoiceMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelVoiceMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelVoiceMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelVoiceMessage(val *CancelVoiceMessage) *NullableCancelVoiceMessage {
	return &NullableCancelVoiceMessage{value: val, isSet: true}
}

func (v NullableCancelVoiceMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelVoiceMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
