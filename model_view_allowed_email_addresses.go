...
// checks if the ViewAllowedEmailAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllowedEmailAddresses{}

// ViewAllowedEmailAddresses struct for ViewAllowedEmailAddresses
type ViewAllowedEmailAddresses struct {
	...
	Data *ViewAllowedEmailAddressesData `json:"data,omitempty"`
}
...
func NewViewAllowedEmailAddresses() *ViewAllowedEmailAddresses {
	this := ViewAllowedEmailAddresses{}
	return &this
}
...
func (o *ViewAllowedEmailAddresses) GetData() ViewAllowedEmailAddressesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewAllowedEmailAddressesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewAllowedEmailAddressesData and assigns it to the Data field.
func (o *ViewAllowedEmailAddresses) SetData(v ViewAllowedEmailAddressesData) {
	o.Data = &v
}

func (o ViewAllowedEmailAddresses) MarshalJSON() ([]byte, error) {
...
func (o ViewAllowedEmailAddresses) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllowedEmailAddresses struct {
	value *ViewAllowedEmailAddresses
	isSet bool
}

func (v NullableViewAllowedEmailAddresses) Get() *ViewAllowedEmailAddresses {
	return v.value
}

func (v *NullableViewAllowedEmailAddresses) Set(val *ViewAllowedEmailAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllowedEmailAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllowedEmailAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllowedEmailAddresses(val *ViewAllowedEmailAddresses) *NullableViewAllowedEmailAddresses {
	return &NullableViewAllowedEmailAddresses{value: val, isSet: true}
}

func (v NullableViewAllowedEmailAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllowedEmailAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
