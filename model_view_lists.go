...
// checks if the ViewLists type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLists{}

// ViewLists struct for ViewLists
type ViewLists struct {
	...
	Data *ViewListsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewListsData and assigns it to the Data field.
func (o *ViewLists) SetData(v ViewListsData) {
	o.Data = &v
}

func (o ViewLists) MarshalJSON() ([]byte, error) {
...
func (o ViewLists) ToMap() (map[string]interface{}, error) {
...
type NullableViewLists struct {
	value *ViewLists
	isSet bool
}

func (v NullableViewLists) Get() *ViewLists {
	return v.value
}

func (v *NullableViewLists) Set(val *ViewLists) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLists) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLists) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLists(val *ViewLists) *NullableViewLists {
	return &NullableViewLists{value: val, isSet: true}
}

func (v NullableViewLists) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLists) UnmarshalJSON(src []byte) error {
	v.isSet = true
