...
// checks if the SendFaxData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendFaxData{}

// SendFaxData struct for SendFaxData
type SendFaxData struct {
...
// SetMessages gets a reference to the given []Fax and assigns it to the Messages field.
...
func (o SendFaxData) MarshalJSON() ([]byte, error) {
...
func (o SendFaxData) ToMap() (map[string]interface{}, error) {
...
type NullableSendFaxData struct {
	value *SendFaxData
	isSet bool
}

func (v NullableSendFaxData) Get() *SendFaxData {
	return v.value
}

func (v *NullableSendFaxData) Set(val *SendFaxData) {
	v.value = val
	v.isSet = true
}

func (v NullableSendFaxData) IsSet() bool {
	return v.isSet
}

func (v *NullableSendFaxData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendFaxData(val *SendFaxData) *NullableSendFaxData {
	return &NullableSendFaxData{value: val, isSet: true}
}

func (v NullableSendFaxData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendFaxData) UnmarshalJSON(src []byte) error {
	v.isSet = true
