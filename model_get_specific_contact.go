...
// checks if the GetSpecificContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSpecificContact{}

// GetSpecificContact struct for GetSpecificContact
type GetSpecificContact struct {
...
func (o GetSpecificContact) MarshalJSON() ([]byte, error) {
...
func (o GetSpecificContact) ToMap() (map[string]interface{}, error) {
...
type NullableGetSpecificContact struct {
	value *GetSpecificContact
	isSet bool
}

func (v NullableGetSpecificContact) Get() *GetSpecificContact {
	return v.value
}

func (v *NullableGetSpecificContact) Set(val *GetSpecificContact) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSpecificContact) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSpecificContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSpecificContact(val *GetSpecificContact) *NullableGetSpecificContact {
	return &NullableGetSpecificContact{value: val, isSet: true}
}

func (v NullableGetSpecificContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSpecificContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
