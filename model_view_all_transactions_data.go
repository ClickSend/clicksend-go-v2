...
// checks if the ViewAllTransactionsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllTransactionsData{}

// ViewAllTransactionsData struct for ViewAllTransactionsData
type ViewAllTransactionsData struct {
...
func (o *ViewAllTransactionsData) SetNextPageUrlNil() {
...
func (o *ViewAllTransactionsData) SetPrevPageUrlNil() {
...
func (o ViewAllTransactionsData) MarshalJSON() ([]byte, error) {
...
func (o ViewAllTransactionsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllTransactionsData struct {
	value *ViewAllTransactionsData
	isSet bool
}

func (v NullableViewAllTransactionsData) Get() *ViewAllTransactionsData {
	return v.value
}

func (v *NullableViewAllTransactionsData) Set(val *ViewAllTransactionsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllTransactionsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllTransactionsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllTransactionsData(val *ViewAllTransactionsData) *NullableViewAllTransactionsData {
	return &NullableViewAllTransactionsData{value: val, isSet: true}
}

func (v NullableViewAllTransactionsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllTransactionsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
