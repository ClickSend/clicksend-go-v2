...
// checks if the SendMmsCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendMmsCampaign{}

// SendMmsCampaign struct for SendMmsCampaign
type SendMmsCampaign struct {
...
func (o SendMmsCampaign) MarshalJSON() ([]byte, error) {
...
func (o SendMmsCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableSendMmsCampaign struct {
	value *SendMmsCampaign
	isSet bool
}

func (v NullableSendMmsCampaign) Get() *SendMmsCampaign {
	return v.value
}

func (v *NullableSendMmsCampaign) Set(val *SendMmsCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableSendMmsCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableSendMmsCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendMmsCampaign(val *SendMmsCampaign) *NullableSendMmsCampaign {
	return &NullableSendMmsCampaign{value: val, isSet: true}
}

func (v NullableSendMmsCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendMmsCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
