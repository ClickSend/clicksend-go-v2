...
// checks if the ViewPostcardHistoryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewPostcardHistoryData{}

// ViewPostcardHistoryData struct for ViewPostcardHistoryData
type ViewPostcardHistoryData struct {
	...
	Data []PostcardRecipient `json:"data,omitempty"`
}
...
func (o *ViewPostcardHistoryData) SetNextPageUrlNil() {
...
func (o *ViewPostcardHistoryData) SetPrevPageUrlNil() {
...
// SetData gets a reference to the given []PostcardRecipient and assigns it to the Data field.
func (o *ViewPostcardHistoryData) SetData(v []PostcardRecipient) {
	o.Data = v
}

func (o ViewPostcardHistoryData) MarshalJSON() ([]byte, error) {
...
func (o ViewPostcardHistoryData) ToMap() (map[string]interface{}, error) {
...
type NullableViewPostcardHistoryData struct {
	value *ViewPostcardHistoryData
	isSet bool
}

func (v NullableViewPostcardHistoryData) Get() *ViewPostcardHistoryData {
	return v.value
}

func (v *NullableViewPostcardHistoryData) Set(val *ViewPostcardHistoryData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewPostcardHistoryData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewPostcardHistoryData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewPostcardHistoryData(val *ViewPostcardHistoryData) *NullableViewPostcardHistoryData {
	return &NullableViewPostcardHistoryData{value: val, isSet: true}
}

func (v NullableViewPostcardHistoryData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewPostcardHistoryData) UnmarshalJSON(src []byte) error {
	v.isSet = true
