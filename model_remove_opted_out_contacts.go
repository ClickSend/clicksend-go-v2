...
// checks if the RemoveOptedOutContacts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveOptedOutContacts{}

// RemoveOptedOutContacts struct for RemoveOptedOutContacts
type RemoveOptedOutContacts struct {
...
func (o RemoveOptedOutContacts) MarshalJSON() ([]byte, error) {
...
func (o RemoveOptedOutContacts) ToMap() (map[string]interface{}, error) {
...
type NullableRemoveOptedOutContacts struct {
	value *RemoveOptedOutContacts
	isSet bool
}

func (v NullableRemoveOptedOutContacts) Get() *RemoveOptedOutContacts {
	return v.value
}

func (v *NullableRemoveOptedOutContacts) Set(val *RemoveOptedOutContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoveOptedOutContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoveOptedOutContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoveOptedOutContacts(val *RemoveOptedOutContacts) *NullableRemoveOptedOutContacts {
	return &NullableRemoveOptedOutContacts{value: val, isSet: true}
}

func (v NullableRemoveOptedOutContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoveOptedOutContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
