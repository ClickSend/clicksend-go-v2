...
// checks if the UpdateClientAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateClientAccount{}

// UpdateClientAccount struct for UpdateClientAccount
type UpdateClientAccount struct {
...
func (o UpdateClientAccount) MarshalJSON() ([]byte, error) {
...
func (o UpdateClientAccount) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateClientAccount struct {
	value *UpdateClientAccount
	isSet bool
}

func (v NullableUpdateClientAccount) Get() *UpdateClientAccount {
	return v.value
}

func (v *NullableUpdateClientAccount) Set(val *UpdateClientAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateClientAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateClientAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateClientAccount(val *UpdateClientAccount) *NullableUpdateClientAccount {
	return &NullableUpdateClientAccount{value: val, isSet: true}
}

func (v NullableUpdateClientAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateClientAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
