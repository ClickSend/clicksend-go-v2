...
// checks if the CreateFaxDeliveryReceiptRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFaxDeliveryReceiptRule{}

// CreateFaxDeliveryReceiptRule struct for CreateFaxDeliveryReceiptRule
type CreateFaxDeliveryReceiptRule struct {
...
func NewCreateFaxDeliveryReceiptRule() *CreateFaxDeliveryReceiptRule {
	this := CreateFaxDeliveryReceiptRule{}
	return &this
}
...
func (o CreateFaxDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
...
func (o CreateFaxDeliveryReceiptRule) ToMap() (map[string]interface{}, error) {
...
type NullableCreateFaxDeliveryReceiptRule struct {
	value *CreateFaxDeliveryReceiptRule
	isSet bool
}

func (v NullableCreateFaxDeliveryReceiptRule) Get() *CreateFaxDeliveryReceiptRule {
	return v.value
}

func (v *NullableCreateFaxDeliveryReceiptRule) Set(val *CreateFaxDeliveryReceiptRule) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFaxDeliveryReceiptRule) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFaxDeliveryReceiptRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFaxDeliveryReceiptRule(val *CreateFaxDeliveryReceiptRule) *NullableCreateFaxDeliveryReceiptRule {
	return &NullableCreateFaxDeliveryReceiptRule{value: val, isSet: true}
}

func (v NullableCreateFaxDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFaxDeliveryReceiptRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
