...
// checks if the CreateVoiceDeliveryReceiptRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVoiceDeliveryReceiptRule{}

// CreateVoiceDeliveryReceiptRule struct for CreateVoiceDeliveryReceiptRule
type CreateVoiceDeliveryReceiptRule struct {
...
func NewCreateVoiceDeliveryReceiptRule() *CreateVoiceDeliveryReceiptRule {
	this := CreateVoiceDeliveryReceiptRule{}
	return &this
}
...
func (o CreateVoiceDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
...
func (o CreateVoiceDeliveryReceiptRule) ToMap() (map[string]interface{}, error) {
...
type NullableCreateVoiceDeliveryReceiptRule struct {
	value *CreateVoiceDeliveryReceiptRule
	isSet bool
}

func (v NullableCreateVoiceDeliveryReceiptRule) Get() *CreateVoiceDeliveryReceiptRule {
	return v.value
}

func (v *NullableCreateVoiceDeliveryReceiptRule) Set(val *CreateVoiceDeliveryReceiptRule) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVoiceDeliveryReceiptRule) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVoiceDeliveryReceiptRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVoiceDeliveryReceiptRule(val *CreateVoiceDeliveryReceiptRule) *NullableCreateVoiceDeliveryReceiptRule {
	return &NullableCreateVoiceDeliveryReceiptRule{value: val, isSet: true}
}

func (v NullableCreateVoiceDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVoiceDeliveryReceiptRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
