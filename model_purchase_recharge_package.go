...
// checks if the PurchaseRechargePackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PurchaseRechargePackage{}

// PurchaseRechargePackage struct for PurchaseRechargePackage
type PurchaseRechargePackage struct {
	...
	Data *PurchaseRechargePackageData `json:"data,omitempty"`
}
...
func (o *PurchaseRechargePackage) GetData() PurchaseRechargePackageData {
	if o == nil || IsNil(o.Data) {
		var ret PurchaseRechargePackageData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given PurchaseRechargePackageData and assigns it to the Data field.
func (o *PurchaseRechargePackage) SetData(v PurchaseRechargePackageData) {
	o.Data = &v
}

func (o PurchaseRechargePackage) MarshalJSON() ([]byte, error) {
...
func (o PurchaseRechargePackage) ToMap() (map[string]interface{}, error) {
...
type NullablePurchaseRechargePackage struct {
	value *PurchaseRechargePackage
	isSet bool
}

func (v NullablePurchaseRechargePackage) Get() *PurchaseRechargePackage {
	return v.value
}

func (v *NullablePurchaseRechargePackage) Set(val *PurchaseRechargePackage) {
	v.value = val
	v.isSet = true
}

func (v NullablePurchaseRechargePackage) IsSet() bool {
	return v.isSet
}

func (v *NullablePurchaseRechargePackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePurchaseRechargePackage(val *PurchaseRechargePackage) *NullablePurchaseRechargePackage {
	return &NullablePurchaseRechargePackage{value: val, isSet: true}
}

func (v NullablePurchaseRechargePackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePurchaseRechargePackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
