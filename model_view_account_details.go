...
// checks if the ViewAccountDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAccountDetails{}

// ViewAccountDetails struct for ViewAccountDetails
type ViewAccountDetails struct {
...
func (o ViewAccountDetails) MarshalJSON() ([]byte, error) {
...
func (o ViewAccountDetails) ToMap() (map[string]interface{}, error) {
...
type NullableViewAccountDetails struct {
	value *ViewAccountDetails
	isSet bool
}

func (v NullableViewAccountDetails) Get() *ViewAccountDetails {
	return v.value
}

func (v *NullableViewAccountDetails) Set(val *ViewAccountDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAccountDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAccountDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAccountDetails(val *ViewAccountDetails) *NullableViewAccountDetails {
	return &NullableViewAccountDetails{value: val, isSet: true}
}

func (v NullableViewAccountDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAccountDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
