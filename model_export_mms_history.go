...
// checks if the ExportMmsHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportMmsHistory{}

// ExportMmsHistory struct for ExportMmsHistory
type ExportMmsHistory struct {
...
func (o ExportMmsHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportMmsHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportMmsHistory struct {
	value *ExportMmsHistory
	isSet bool
}

func (v NullableExportMmsHistory) Get() *ExportMmsHistory {
	return v.value
}

func (v *NullableExportMmsHistory) Set(val *ExportMmsHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportMmsHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportMmsHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportMmsHistory(val *ExportMmsHistory) *NullableExportMmsHistory {
	return &NullableExportMmsHistory{value: val, isSet: true}
}

func (v NullableExportMmsHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportMmsHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
