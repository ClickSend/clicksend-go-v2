...
// checks if the UpdateReturnAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateReturnAddress{}

// UpdateReturnAddress struct for UpdateReturnAddress
type UpdateReturnAddress struct {
...
func (o UpdateReturnAddress) MarshalJSON() ([]byte, error) {
...
func (o UpdateReturnAddress) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateReturnAddress struct {
	value *UpdateReturnAddress
	isSet bool
}

func (v NullableUpdateReturnAddress) Get() *UpdateReturnAddress {
	return v.value
}

func (v *NullableUpdateReturnAddress) Set(val *UpdateReturnAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateReturnAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateReturnAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateReturnAddress(val *UpdateReturnAddress) *NullableUpdateReturnAddress {
	return &NullableUpdateReturnAddress{value: val, isSet: true}
}

func (v NullableUpdateReturnAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateReturnAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
