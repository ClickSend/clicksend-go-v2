...
// checks if the ViewEmailCampaignHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailCampaignHistory{}

// ViewEmailCampaignHistory struct for ViewEmailCampaignHistory
type ViewEmailCampaignHistory struct {
	...
	Data *ViewEmailCampaignHistoryData `json:"data,omitempty"`
}
...
func (o *ViewEmailCampaignHistory) GetData() ViewEmailCampaignHistoryData {
	if o == nil || IsNil(o.Data) {
		var ret ViewEmailCampaignHistoryData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewEmailCampaignHistoryData and assigns it to the Data field.
func (o *ViewEmailCampaignHistory) SetData(v ViewEmailCampaignHistoryData) {
	o.Data = &v
}

func (o ViewEmailCampaignHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailCampaignHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailCampaignHistory struct {
	value *ViewEmailCampaignHistory
	isSet bool
}

func (v NullableViewEmailCampaignHistory) Get() *ViewEmailCampaignHistory {
	return v.value
}

func (v *NullableViewEmailCampaignHistory) Set(val *ViewEmailCampaignHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailCampaignHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailCampaignHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailCampaignHistory(val *ViewEmailCampaignHistory) *NullableViewEmailCampaignHistory {
	return &NullableViewEmailCampaignHistory{value: val, isSet: true}
}

func (v NullableViewEmailCampaignHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailCampaignHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
