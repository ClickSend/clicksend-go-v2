...
func (o *ViewAccountUsageDataSmsInner) GetTotalPrice() string {
...
// and a boolean to check if the value has been set.
func (o *ViewAccountUsageDataSmsInner) GetTotalPriceOk() (*string, bool) {
	if o == nil || IsNil(o.TotalPrice) {
		return nil, false
	}
...
func (o *ViewAccountUsageDataSmsInner) SetTotalPrice(v string) {
	o.TotalPrice = &v
}
