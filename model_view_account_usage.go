...
// checks if the ViewAccountUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAccountUsage{}

// ViewAccountUsage struct for ViewAccountUsage
type ViewAccountUsage struct {
	...
	Data *ViewAccountUsageData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewAccountUsageData and assigns it to the Data field.
func (o *ViewAccountUsage) SetData(v ViewAccountUsageData) {
	o.Data = &v
}

func (o ViewAccountUsage) MarshalJSON() ([]byte, error) {
...
func (o ViewAccountUsage) ToMap() (map[string]interface{}, error) {
...
type NullableViewAccountUsage struct {
	value *ViewAccountUsage
	isSet bool
}

func (v NullableViewAccountUsage) Get() *ViewAccountUsage {
	return v.value
}

func (v *NullableViewAccountUsage) Set(val *ViewAccountUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAccountUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAccountUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAccountUsage(val *ViewAccountUsage) *NullableViewAccountUsage {
	return &NullableViewAccountUsage{value: val, isSet: true}
}

func (v NullableViewAccountUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAccountUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
