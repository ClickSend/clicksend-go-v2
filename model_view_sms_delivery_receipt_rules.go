...
// checks if the ViewSmsDeliveryReceiptRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsDeliveryReceiptRules{}

// ViewSmsDeliveryReceiptRules struct for ViewSmsDeliveryReceiptRules
type ViewSmsDeliveryReceiptRules struct {
	...
	Data *ViewSmsDeliveryReceiptRulesData `json:"data,omitempty"`
}
...
func NewViewSmsDeliveryReceiptRules() *ViewSmsDeliveryReceiptRules {
	this := ViewSmsDeliveryReceiptRules{}
	return &this
}
...
func (o *ViewSmsDeliveryReceiptRules) GetData() ViewSmsDeliveryReceiptRulesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewSmsDeliveryReceiptRulesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewSmsDeliveryReceiptRulesData and assigns it to the Data field.
func (o *ViewSmsDeliveryReceiptRules) SetData(v ViewSmsDeliveryReceiptRulesData) {
	o.Data = &v
}

func (o ViewSmsDeliveryReceiptRules) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsDeliveryReceiptRules) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsDeliveryReceiptRules struct {
	value *ViewSmsDeliveryReceiptRules
	isSet bool
}

func (v NullableViewSmsDeliveryReceiptRules) Get() *ViewSmsDeliveryReceiptRules {
	return v.value
}

func (v *NullableViewSmsDeliveryReceiptRules) Set(val *ViewSmsDeliveryReceiptRules) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsDeliveryReceiptRules) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsDeliveryReceiptRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsDeliveryReceiptRules(val *ViewSmsDeliveryReceiptRules) *NullableViewSmsDeliveryReceiptRules {
	return &NullableViewSmsDeliveryReceiptRules{value: val, isSet: true}
}

func (v NullableViewSmsDeliveryReceiptRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsDeliveryReceiptRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
