...
// checks if the CreateEmailTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEmailTemplate{}

// CreateEmailTemplate struct for CreateEmailTemplate
...
func (o CreateEmailTemplate) MarshalJSON() ([]byte, error) {
...
func (o CreateEmailTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableCreateEmailTemplate struct {
	value *CreateEmailTemplate
	isSet bool
}

func (v NullableCreateEmailTemplate) Get() *CreateEmailTemplate {
	return v.value
}

func (v *NullableCreateEmailTemplate) Set(val *CreateEmailTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEmailTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEmailTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEmailTemplate(val *CreateEmailTemplate) *NullableCreateEmailTemplate {
	return &NullableCreateEmailTemplate{value: val, isSet: true}
}

func (v NullableCreateEmailTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEmailTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
