...
// checks if the SendEmailCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendEmailCampaign{}

// SendEmailCampaign struct for SendEmailCampaign
type SendEmailCampaign struct {
	...
	Data *SendEmailCampaignData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given SendEmailCampaignData and assigns it to the Data field.
func (o *SendEmailCampaign) SetData(v SendEmailCampaignData) {
	o.Data = &v
}

func (o SendEmailCampaign) MarshalJSON() ([]byte, error) {
...
func (o SendEmailCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableSendEmailCampaign struct {
	value *SendEmailCampaign
	isSet bool
}

func (v NullableSendEmailCampaign) Get() *SendEmailCampaign {
	return v.value
}

func (v *NullableSendEmailCampaign) Set(val *SendEmailCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableSendEmailCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableSendEmailCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendEmailCampaign(val *SendEmailCampaign) *NullableSendEmailCampaign {
	return &NullableSendEmailCampaign{value: val, isSet: true}
}

func (v NullableSendEmailCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendEmailCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
