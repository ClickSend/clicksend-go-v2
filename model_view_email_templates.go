...
// checks if the ViewEmailTemplates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailTemplates{}

// ViewEmailTemplates struct for ViewEmailTemplates
type ViewEmailTemplates struct {
	...
	Data *ViewEmailTemplatesData `json:"data,omitempty"`
}
...
func (o *ViewEmailTemplates) GetData() ViewEmailTemplatesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewEmailTemplatesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewEmailTemplatesData and assigns it to the Data field.
func (o *ViewEmailTemplates) SetData(v ViewEmailTemplatesData) {
	o.Data = &v
}

func (o ViewEmailTemplates) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailTemplates) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailTemplates struct {
	value *ViewEmailTemplates
	isSet bool
}

func (v NullableViewEmailTemplates) Get() *ViewEmailTemplates {
	return v.value
}

func (v *NullableViewEmailTemplates) Set(val *ViewEmailTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailTemplates(val *ViewEmailTemplates) *NullableViewEmailTemplates {
	return &NullableViewEmailTemplates{value: val, isSet: true}
}

func (v NullableViewEmailTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
