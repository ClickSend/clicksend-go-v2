...
// checks if the ViewAccountUsageDataEmailInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAccountUsageDataEmailInner{}

// ViewAccountUsageDataEmailInner struct for ViewAccountUsageDataEmailInner
type ViewAccountUsageDataEmailInner struct {
...
func NewViewAccountUsageDataEmailInner() *ViewAccountUsageDataEmailInner {
	this := ViewAccountUsageDataEmailInner{}
	return &this
}
...
func (o *ViewAccountUsageDataEmailInner) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o ViewAccountUsageDataEmailInner) MarshalJSON() ([]byte, error) {
...
func (o ViewAccountUsageDataEmailInner) ToMap() (map[string]interface{}, error) {
...
type NullableViewAccountUsageDataEmailInner struct {
	value *ViewAccountUsageDataEmailInner
	isSet bool
}

func (v NullableViewAccountUsageDataEmailInner) Get() *ViewAccountUsageDataEmailInner {
	return v.value
}

func (v *NullableViewAccountUsageDataEmailInner) Set(val *ViewAccountUsageDataEmailInner) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAccountUsageDataEmailInner) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAccountUsageDataEmailInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAccountUsageDataEmailInner(val *ViewAccountUsageDataEmailInner) *NullableViewAccountUsageDataEmailInner {
	return &NullableViewAccountUsageDataEmailInner{value: val, isSet: true}
}

func (v NullableViewAccountUsageDataEmailInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAccountUsageDataEmailInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
