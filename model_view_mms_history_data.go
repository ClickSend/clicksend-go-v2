...
// checks if the ViewMmsHistoryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewMmsHistoryData{}

// ViewMmsHistoryData struct for ViewMmsHistoryData
type ViewMmsHistoryData struct {
	...
	Data []ViewMmsHistoryDataAllOfDataInner `json:"data,omitempty"`
}
...
func (o *ViewMmsHistoryData) SetNextPageUrlNil() {
...
func (o *ViewMmsHistoryData) SetPrevPageUrlNil() {
...
func (o *ViewMmsHistoryData) GetData() []ViewMmsHistoryDataAllOfDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ViewMmsHistoryDataAllOfDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ViewMmsHistoryDataAllOfDataInner and assigns it to the Data field.
func (o *ViewMmsHistoryData) SetData(v []ViewMmsHistoryDataAllOfDataInner) {
	o.Data = v
}

func (o ViewMmsHistoryData) MarshalJSON() ([]byte, error) {
...
func (o ViewMmsHistoryData) ToMap() (map[string]interface{}, error) {
...
type NullableViewMmsHistoryData struct {
	value *ViewMmsHistoryData
	isSet bool
}

func (v NullableViewMmsHistoryData) Get() *ViewMmsHistoryData {
	return v.value
}

func (v *NullableViewMmsHistoryData) Set(val *ViewMmsHistoryData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewMmsHistoryData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewMmsHistoryData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewMmsHistoryData(val *ViewMmsHistoryData) *NullableViewMmsHistoryData {
	return &NullableViewMmsHistoryData{value: val, isSet: true}
}

func (v NullableViewMmsHistoryData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewMmsHistoryData) UnmarshalJSON(src []byte) error {
	v.isSet = true
