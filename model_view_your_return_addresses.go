...
// checks if the ViewYourReturnAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewYourReturnAddresses{}

// ViewYourReturnAddresses struct for ViewYourReturnAddresses
type ViewYourReturnAddresses struct {
	...
	Data *ViewYourReturnAddressesData `json:"data,omitempty"`
}
...
func (o *ViewYourReturnAddresses) GetData() ViewYourReturnAddressesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewYourReturnAddressesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewYourReturnAddressesData and assigns it to the Data field.
func (o *ViewYourReturnAddresses) SetData(v ViewYourReturnAddressesData) {
	o.Data = &v
}

func (o ViewYourReturnAddresses) MarshalJSON() ([]byte, error) {
...
func (o ViewYourReturnAddresses) ToMap() (map[string]interface{}, error) {
...
type NullableViewYourReturnAddresses struct {
	value *ViewYourReturnAddresses
	isSet bool
}

func (v NullableViewYourReturnAddresses) Get() *ViewYourReturnAddresses {
	return v.value
}

func (v *NullableViewYourReturnAddresses) Set(val *ViewYourReturnAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableViewYourReturnAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableViewYourReturnAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewYourReturnAddresses(val *ViewYourReturnAddresses) *NullableViewYourReturnAddresses {
	return &NullableViewYourReturnAddresses{value: val, isSet: true}
}

func (v NullableViewYourReturnAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewYourReturnAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
