...
// checks if the RegisterNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterNumbers{}

// RegisterNumbers struct for RegisterNumbers
type RegisterNumbers struct {
...
type _RegisterNumbers RegisterNumbers
...
func (o RegisterNumbers) MarshalJSON() ([]byte, error) {
...
func (o RegisterNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *RegisterNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varRegisterNumbers := _RegisterNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegisterNumbers)

	if err != nil {
		return err
	}

	*o = RegisterNumbers(varRegisterNumbers)

	return err
}

type NullableRegisterNumbers struct {
	value *RegisterNumbers
	isSet bool
}

func (v NullableRegisterNumbers) Get() *RegisterNumbers {
	return v.value
}

func (v *NullableRegisterNumbers) Set(val *RegisterNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterNumbers(val *RegisterNumbers) *NullableRegisterNumbers {
	return &NullableRegisterNumbers{value: val, isSet: true}
}

func (v NullableRegisterNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
