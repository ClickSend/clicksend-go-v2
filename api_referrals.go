...
type ApiViewReferralAccountsRequest struct {
	ctx context.Context
	ApiService *ReferralsAPIService
	contentType *string
}

func (r ApiViewReferralAccountsRequest) ContentType(contentType string) ApiViewReferralAccountsRequest {
	r.contentType = &contentType
	return r
}

func (r ApiViewReferralAccountsRequest) Execute() (*ViewReferralAccounts, *http.Response, error) {
	return r.ApiService.ViewReferralAccountsExecute(r)
}

/*
ViewReferralAccounts View Referral Accounts
...
<div style="background-color: #FF6A4B; padding: 10px; border-radius: 8px;">
 ...
 @return ApiViewReferralAccountsRequest
*/
func (a *ReferralsAPIService) ViewReferralAccounts(ctx context.Context) ApiViewReferralAccountsRequest {
	return ApiViewReferralAccountsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReferralsAPIService) ViewReferralAccountsExecute(r ApiViewReferralAccountsRequest) (*ViewReferralAccounts, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ViewReferralAccounts
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReferralsAPIService.ViewReferralAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/referral/accounts/"
