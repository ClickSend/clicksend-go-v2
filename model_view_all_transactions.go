...
// checks if the ViewAllTransactions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllTransactions{}

// ViewAllTransactions struct for ViewAllTransactions
type ViewAllTransactions struct {
	...
	Data *ViewAllTransactionsData `json:"data,omitempty"`
}
...
func (o *ViewAllTransactions) GetData() ViewAllTransactionsData {
	if o == nil || IsNil(o.Data) {
		var ret ViewAllTransactionsData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewAllTransactionsData and assigns it to the Data field.
func (o *ViewAllTransactions) SetData(v ViewAllTransactionsData) {
	o.Data = &v
}

func (o ViewAllTransactions) MarshalJSON() ([]byte, error) {
...
func (o ViewAllTransactions) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllTransactions struct {
	value *ViewAllTransactions
	isSet bool
}

func (v NullableViewAllTransactions) Get() *ViewAllTransactions {
	return v.value
}

func (v *NullableViewAllTransactions) Set(val *ViewAllTransactions) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllTransactions) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllTransactions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllTransactions(val *ViewAllTransactions) *NullableViewAllTransactions {
	return &NullableViewAllTransactions{value: val, isSet: true}
}

func (v NullableViewAllTransactions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllTransactions) UnmarshalJSON(src []byte) error {
	v.isSet = true
