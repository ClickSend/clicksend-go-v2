...
// checks if the SendEmailVerificationToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendEmailVerificationToken{}

// SendEmailVerificationToken struct for SendEmailVerificationToken
...
func (o SendEmailVerificationToken) MarshalJSON() ([]byte, error) {
...
func (o SendEmailVerificationToken) ToMap() (map[string]interface{}, error) {
...
type NullableSendEmailVerificationToken struct {
	value *SendEmailVerificationToken
	isSet bool
}

func (v NullableSendEmailVerificationToken) Get() *SendEmailVerificationToken {
	return v.value
}

func (v *NullableSendEmailVerificationToken) Set(val *SendEmailVerificationToken) {
	v.value = val
	v.isSet = true
}

func (v NullableSendEmailVerificationToken) IsSet() bool {
	return v.isSet
}

func (v *NullableSendEmailVerificationToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendEmailVerificationToken(val *SendEmailVerificationToken) *NullableSendEmailVerificationToken {
	return &NullableSendEmailVerificationToken{value: val, isSet: true}
}

func (v NullableSendEmailVerificationToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendEmailVerificationToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
