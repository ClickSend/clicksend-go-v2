...
// checks if the GetAllDeliveryIssues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllDeliveryIssues{}

// GetAllDeliveryIssues struct for GetAllDeliveryIssues
type GetAllDeliveryIssues struct {
...
func (o GetAllDeliveryIssues) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllDeliveryIssues struct {
	value *GetAllDeliveryIssues
	isSet bool
}

func (v NullableGetAllDeliveryIssues) Get() *GetAllDeliveryIssues {
	return v.value
}

func (v *NullableGetAllDeliveryIssues) Set(val *GetAllDeliveryIssues) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllDeliveryIssues) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllDeliveryIssues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllDeliveryIssues(val *GetAllDeliveryIssues) *NullableGetAllDeliveryIssues {
	return &NullableGetAllDeliveryIssues{value: val, isSet: true}
}

func (v NullableGetAllDeliveryIssues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllDeliveryIssues) UnmarshalJSON(src []byte) error {
	v.isSet = true
