...
// checks if the AddAllowedEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddAllowedEmail{}

// AddAllowedEmail struct for AddAllowedEmail
type AddAllowedEmail struct {
...
func (o AddAllowedEmail) MarshalJSON() ([]byte, error) {
...
func (o AddAllowedEmail) ToMap() (map[string]interface{}, error) {
...
type NullableAddAllowedEmail struct {
	value *AddAllowedEmail
	isSet bool
}

func (v NullableAddAllowedEmail) Get() *AddAllowedEmail {
	return v.value
}

func (v *NullableAddAllowedEmail) Set(val *AddAllowedEmail) {
	v.value = val
	v.isSet = true
}

func (v NullableAddAllowedEmail) IsSet() bool {
	return v.isSet
}

func (v *NullableAddAllowedEmail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddAllowedEmail(val *AddAllowedEmail) *NullableAddAllowedEmail {
	return &NullableAddAllowedEmail{value: val, isSet: true}
}

func (v NullableAddAllowedEmail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddAllowedEmail) UnmarshalJSON(src []byte) error {
	v.isSet = true
