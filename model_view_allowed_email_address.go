...
// checks if the ViewAllowedEmailAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllowedEmailAddress{}

// ViewAllowedEmailAddress struct for ViewAllowedEmailAddress
type ViewAllowedEmailAddress struct {
...
func (o ViewAllowedEmailAddress) MarshalJSON() ([]byte, error) {
...
func (o ViewAllowedEmailAddress) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllowedEmailAddress struct {
	value *ViewAllowedEmailAddress
	isSet bool
}

func (v NullableViewAllowedEmailAddress) Get() *ViewAllowedEmailAddress {
	return v.value
}

func (v *NullableViewAllowedEmailAddress) Set(val *ViewAllowedEmailAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllowedEmailAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllowedEmailAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllowedEmailAddress(val *ViewAllowedEmailAddress) *NullableViewAllowedEmailAddress {
	return &NullableViewAllowedEmailAddress{value: val, isSet: true}
}

func (v NullableViewAllowedEmailAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllowedEmailAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
