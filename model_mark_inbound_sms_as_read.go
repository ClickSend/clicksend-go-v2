...
// checks if the MarkInboundSmsAsRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarkInboundSmsAsRead{}

// MarkInboundSmsAsRead struct for MarkInboundSmsAsRead
type MarkInboundSmsAsRead struct {
...
func (o MarkInboundSmsAsRead) MarshalJSON() ([]byte, error) {
...
func (o MarkInboundSmsAsRead) ToMap() (map[string]interface{}, error) {
...
type NullableMarkInboundSmsAsRead struct {
	value *MarkInboundSmsAsRead
	isSet bool
}

func (v NullableMarkInboundSmsAsRead) Get() *MarkInboundSmsAsRead {
	return v.value
}

func (v *NullableMarkInboundSmsAsRead) Set(val *MarkInboundSmsAsRead) {
	v.value = val
	v.isSet = true
}

func (v NullableMarkInboundSmsAsRead) IsSet() bool {
	return v.isSet
}

func (v *NullableMarkInboundSmsAsRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarkInboundSmsAsRead(val *MarkInboundSmsAsRead) *NullableMarkInboundSmsAsRead {
	return &NullableMarkInboundSmsAsRead{value: val, isSet: true}
}

func (v NullableMarkInboundSmsAsRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarkInboundSmsAsRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
