...
// checks if the ViewSpecificList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSpecificList{}

// ViewSpecificList struct for ViewSpecificList
type ViewSpecificList struct {
...
func (o ViewSpecificList) MarshalJSON() ([]byte, error) {
...
func (o ViewSpecificList) ToMap() (map[string]interface{}, error) {
...
type NullableViewSpecificList struct {
	value *ViewSpecificList
	isSet bool
}

func (v NullableViewSpecificList) Get() *ViewSpecificList {
	return v.value
}

func (v *NullableViewSpecificList) Set(val *ViewSpecificList) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSpecificList) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSpecificList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSpecificList(val *ViewSpecificList) *NullableViewSpecificList {
	return &NullableViewSpecificList{value: val, isSet: true}
}

func (v NullableViewSpecificList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSpecificList) UnmarshalJSON(src []byte) error {
	v.isSet = true
