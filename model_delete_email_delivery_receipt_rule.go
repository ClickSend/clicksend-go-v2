...
// checks if the DeleteEmailDeliveryReceiptRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteEmailDeliveryReceiptRule{}

// DeleteEmailDeliveryReceiptRule struct for DeleteEmailDeliveryReceiptRule
type DeleteEmailDeliveryReceiptRule struct {
...
func NewDeleteEmailDeliveryReceiptRule() *DeleteEmailDeliveryReceiptRule {
	this := DeleteEmailDeliveryReceiptRule{}
	return &this
}
...
func (o DeleteEmailDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
...
func (o DeleteEmailDeliveryReceiptRule) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteEmailDeliveryReceiptRule struct {
	value *DeleteEmailDeliveryReceiptRule
	isSet bool
}

func (v NullableDeleteEmailDeliveryReceiptRule) Get() *DeleteEmailDeliveryReceiptRule {
	return v.value
}

func (v *NullableDeleteEmailDeliveryReceiptRule) Set(val *DeleteEmailDeliveryReceiptRule) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteEmailDeliveryReceiptRule) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteEmailDeliveryReceiptRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteEmailDeliveryReceiptRule(val *DeleteEmailDeliveryReceiptRule) *NullableDeleteEmailDeliveryReceiptRule {
	return &NullableDeleteEmailDeliveryReceiptRule{value: val, isSet: true}
}

func (v NullableDeleteEmailDeliveryReceiptRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteEmailDeliveryReceiptRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
