...
// checks if the ViewInboundSms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewInboundSms{}

// ViewInboundSms struct for ViewInboundSms
type ViewInboundSms struct {
	...
	Data *ViewInboundSmsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewInboundSmsData and assigns it to the Data field.
func (o *ViewInboundSms) SetData(v ViewInboundSmsData) {
	o.Data = &v
}

func (o ViewInboundSms) MarshalJSON() ([]byte, error) {
...
func (o ViewInboundSms) ToMap() (map[string]interface{}, error) {
...
type NullableViewInboundSms struct {
	value *ViewInboundSms
	isSet bool
}

func (v NullableViewInboundSms) Get() *ViewInboundSms {
	return v.value
}

func (v *NullableViewInboundSms) Set(val *ViewInboundSms) {
	v.value = val
	v.isSet = true
}

func (v NullableViewInboundSms) IsSet() bool {
	return v.isSet
}

func (v *NullableViewInboundSms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewInboundSms(val *ViewInboundSms) *NullableViewInboundSms {
	return &NullableViewInboundSms{value: val, isSet: true}
}

func (v NullableViewInboundSms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewInboundSms) UnmarshalJSON(src []byte) error {
	v.isSet = true
