...
// checks if the ViewSmsTemplates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsTemplates{}

// ViewSmsTemplates struct for ViewSmsTemplates
type ViewSmsTemplates struct {
	...
	Data *ViewSmsTemplatesData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewSmsTemplatesData and assigns it to the Data field.
func (o *ViewSmsTemplates) SetData(v ViewSmsTemplatesData) {
	o.Data = &v
}

func (o ViewSmsTemplates) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsTemplates) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsTemplates struct {
	value *ViewSmsTemplates
	isSet bool
}

func (v NullableViewSmsTemplates) Get() *ViewSmsTemplates {
	return v.value
}

func (v *NullableViewSmsTemplates) Set(val *ViewSmsTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsTemplates(val *ViewSmsTemplates) *NullableViewSmsTemplates {
	return &NullableViewSmsTemplates{value: val, isSet: true}
}

func (v NullableViewSmsTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
