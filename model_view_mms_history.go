...
// checks if the ViewMmsHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewMmsHistory{}

// ViewMmsHistory struct for ViewMmsHistory
type ViewMmsHistory struct {
	...
	Data *ViewMmsHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewMmsHistoryData and assigns it to the Data field.
func (o *ViewMmsHistory) SetData(v ViewMmsHistoryData) {
	o.Data = &v
}

func (o ViewMmsHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewMmsHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewMmsHistory struct {
	value *ViewMmsHistory
	isSet bool
}

func (v NullableViewMmsHistory) Get() *ViewMmsHistory {
	return v.value
}

func (v *NullableViewMmsHistory) Set(val *ViewMmsHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewMmsHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewMmsHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewMmsHistory(val *ViewMmsHistory) *NullableViewMmsHistory {
	return &NullableViewMmsHistory{value: val, isSet: true}
}

func (v NullableViewMmsHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewMmsHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
