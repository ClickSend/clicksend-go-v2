...
// checks if the ViewSmsHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsHistory{}

// ViewSmsHistory struct for ViewSmsHistory
type ViewSmsHistory struct {
	...
	Data *ViewSmsHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewSmsHistoryData and assigns it to the Data field.
func (o *ViewSmsHistory) SetData(v ViewSmsHistoryData) {
	o.Data = &v
}

func (o ViewSmsHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsHistory struct {
	value *ViewSmsHistory
	isSet bool
}

func (v NullableViewSmsHistory) Get() *ViewSmsHistory {
	return v.value
}

func (v *NullableViewSmsHistory) Set(val *ViewSmsHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsHistory(val *ViewSmsHistory) *NullableViewSmsHistory {
	return &NullableViewSmsHistory{value: val, isSet: true}
}

func (v NullableViewSmsHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
