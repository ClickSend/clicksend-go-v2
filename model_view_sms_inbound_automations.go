...
// checks if the ViewSmsInboundAutomations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsInboundAutomations{}

// ViewSmsInboundAutomations struct for ViewSmsInboundAutomations
type ViewSmsInboundAutomations struct {
	...
	Data *ViewSmsInboundAutomationsData `json:"data,omitempty"`
}
...
func NewViewSmsInboundAutomations() *ViewSmsInboundAutomations {
	this := ViewSmsInboundAutomations{}
	return &this
}
...
func (o *ViewSmsInboundAutomations) GetData() ViewSmsInboundAutomationsData {
	if o == nil || IsNil(o.Data) {
		var ret ViewSmsInboundAutomationsData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewSmsInboundAutomationsData and assigns it to the Data field.
func (o *ViewSmsInboundAutomations) SetData(v ViewSmsInboundAutomationsData) {
	o.Data = &v
}

func (o ViewSmsInboundAutomations) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsInboundAutomations) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsInboundAutomations struct {
	value *ViewSmsInboundAutomations
	isSet bool
}

func (v NullableViewSmsInboundAutomations) Get() *ViewSmsInboundAutomations {
	return v.value
}

func (v *NullableViewSmsInboundAutomations) Set(val *ViewSmsInboundAutomations) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsInboundAutomations) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsInboundAutomations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsInboundAutomations(val *ViewSmsInboundAutomations) *NullableViewSmsInboundAutomations {
	return &NullableViewSmsInboundAutomations{value: val, isSet: true}
}

func (v NullableViewSmsInboundAutomations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsInboundAutomations) UnmarshalJSON(src []byte) error {
	v.isSet = true
