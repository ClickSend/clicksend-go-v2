...
// checks if the ViewSmsCampaigns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsCampaigns{}

// ViewSmsCampaigns struct for ViewSmsCampaigns
type ViewSmsCampaigns struct {
	...
	Data *ViewSmsCampaignsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewSmsCampaignsData and assigns it to the Data field.
func (o *ViewSmsCampaigns) SetData(v ViewSmsCampaignsData) {
	o.Data = &v
}

func (o ViewSmsCampaigns) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsCampaigns) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsCampaigns struct {
	value *ViewSmsCampaigns
	isSet bool
}

func (v NullableViewSmsCampaigns) Get() *ViewSmsCampaigns {
	return v.value
}

func (v *NullableViewSmsCampaigns) Set(val *ViewSmsCampaigns) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsCampaigns) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsCampaigns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsCampaigns(val *ViewSmsCampaigns) *NullableViewSmsCampaigns {
	return &NullableViewSmsCampaigns{value: val, isSet: true}
}

func (v NullableViewSmsCampaigns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsCampaigns) UnmarshalJSON(src []byte) error {
	v.isSet = true
