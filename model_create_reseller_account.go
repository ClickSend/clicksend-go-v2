...
// checks if the CreateResellerAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateResellerAccount{}

// CreateResellerAccount struct for CreateResellerAccount
type CreateResellerAccount struct {
...
func (o CreateResellerAccount) MarshalJSON() ([]byte, error) {
...
func (o CreateResellerAccount) ToMap() (map[string]interface{}, error) {
...
type NullableCreateResellerAccount struct {
	value *CreateResellerAccount
	isSet bool
}

func (v NullableCreateResellerAccount) Get() *CreateResellerAccount {
	return v.value
}

func (v *NullableCreateResellerAccount) Set(val *CreateResellerAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateResellerAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateResellerAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateResellerAccount(val *CreateResellerAccount) *NullableCreateResellerAccount {
	return &NullableCreateResellerAccount{value: val, isSet: true}
}

func (v NullableCreateResellerAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateResellerAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
