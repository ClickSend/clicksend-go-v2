...
// checks if the DeleteList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteList{}

// DeleteList struct for DeleteList
...
func (o DeleteList) MarshalJSON() ([]byte, error) {
...
func (o DeleteList) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteList struct {
	value *DeleteList
	isSet bool
}

func (v NullableDeleteList) Get() *DeleteList {
	return v.value
}

func (v *NullableDeleteList) Set(val *DeleteList) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteList) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteList(val *DeleteList) *NullableDeleteList {
	return &NullableDeleteList{value: val, isSet: true}
}

func (v NullableDeleteList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteList) UnmarshalJSON(src []byte) error {
	v.isSet = true
