...
// checks if the CalculateFaxPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalculateFaxPrice{}

// CalculateFaxPrice struct for CalculateFaxPrice
type CalculateFaxPrice struct {
	...
	Data *SendFaxData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given SendFaxData and assigns it to the Data field.
func (o *CalculateFaxPrice) SetData(v SendFaxData) {
	o.Data = &v
}

func (o CalculateFaxPrice) MarshalJSON() ([]byte, error) {
...
func (o CalculateFaxPrice) ToMap() (map[string]interface{}, error) {
...
type NullableCalculateFaxPrice struct {
	value *CalculateFaxPrice
	isSet bool
}

func (v NullableCalculateFaxPrice) Get() *CalculateFaxPrice {
	return v.value
}

func (v *NullableCalculateFaxPrice) Set(val *CalculateFaxPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableCalculateFaxPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableCalculateFaxPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalculateFaxPrice(val *CalculateFaxPrice) *NullableCalculateFaxPrice {
	return &NullableCalculateFaxPrice{value: val, isSet: true}
}

func (v NullableCalculateFaxPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalculateFaxPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
