...
// checks if the CreateAllowedEmailAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAllowedEmailAddress{}

// CreateAllowedEmailAddress struct for CreateAllowedEmailAddress
type CreateAllowedEmailAddress struct {
...
func NewCreateAllowedEmailAddress() *CreateAllowedEmailAddress {
	this := CreateAllowedEmailAddress{}
	return &this
}
...
func (o CreateAllowedEmailAddress) MarshalJSON() ([]byte, error) {
...
func (o CreateAllowedEmailAddress) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAllowedEmailAddress struct {
	value *CreateAllowedEmailAddress
	isSet bool
}

func (v NullableCreateAllowedEmailAddress) Get() *CreateAllowedEmailAddress {
	return v.value
}

func (v *NullableCreateAllowedEmailAddress) Set(val *CreateAllowedEmailAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAllowedEmailAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAllowedEmailAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAllowedEmailAddress(val *CreateAllowedEmailAddress) *NullableCreateAllowedEmailAddress {
	return &NullableCreateAllowedEmailAddress{value: val, isSet: true}
}

func (v NullableCreateAllowedEmailAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAllowedEmailAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
