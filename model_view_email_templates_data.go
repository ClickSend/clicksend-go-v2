...
// checks if the ViewEmailTemplatesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailTemplatesData{}

// ViewEmailTemplatesData struct for ViewEmailTemplatesData
type ViewEmailTemplatesData struct {
	...
	Data []ViewEmailTemplatesDataDataInner `json:"data,omitempty"`
}
...
func (o *ViewEmailTemplatesData) SetNextPageUrlNil() {
...
func (o *ViewEmailTemplatesData) SetPrevPageUrlNil() {
...
func (o *ViewEmailTemplatesData) GetData() []ViewEmailTemplatesDataDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ViewEmailTemplatesDataDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ViewEmailTemplatesDataDataInner and assigns it to the Data field.
func (o *ViewEmailTemplatesData) SetData(v []ViewEmailTemplatesDataDataInner) {
	o.Data = v
}

func (o ViewEmailTemplatesData) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailTemplatesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailTemplatesData struct {
	value *ViewEmailTemplatesData
	isSet bool
}

func (v NullableViewEmailTemplatesData) Get() *ViewEmailTemplatesData {
	return v.value
}

func (v *NullableViewEmailTemplatesData) Set(val *ViewEmailTemplatesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailTemplatesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailTemplatesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailTemplatesData(val *ViewEmailTemplatesData) *NullableViewEmailTemplatesData {
	return &NullableViewEmailTemplatesData{value: val, isSet: true}
}

func (v NullableViewEmailTemplatesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailTemplatesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
