...
// checks if the CalculateEmailPriceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalculateEmailPriceRequest{}

// CalculateEmailPriceRequest struct for CalculateEmailPriceRequest
type CalculateEmailPriceRequest struct {
...
func NewCalculateEmailPriceRequest() *CalculateEmailPriceRequest {
	this := CalculateEmailPriceRequest{}
	return &this
}
...
func (o CalculateEmailPriceRequest) MarshalJSON() ([]byte, error) {
...
func (o CalculateEmailPriceRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCalculateEmailPriceRequest struct {
	value *CalculateEmailPriceRequest
	isSet bool
}

func (v NullableCalculateEmailPriceRequest) Get() *CalculateEmailPriceRequest {
	return v.value
}

func (v *NullableCalculateEmailPriceRequest) Set(val *CalculateEmailPriceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCalculateEmailPriceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCalculateEmailPriceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalculateEmailPriceRequest(val *CalculateEmailPriceRequest) *NullableCalculateEmailPriceRequest {
	return &NullableCalculateEmailPriceRequest{value: val, isSet: true}
}

func (v NullableCalculateEmailPriceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalculateEmailPriceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
