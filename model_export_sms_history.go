...
// checks if the ExportSmsHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportSmsHistory{}

// ExportSmsHistory struct for ExportSmsHistory
type ExportSmsHistory struct {
...
func (o ExportSmsHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportSmsHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportSmsHistory struct {
	value *ExportSmsHistory
	isSet bool
}

func (v NullableExportSmsHistory) Get() *ExportSmsHistory {
	return v.value
}

func (v *NullableExportSmsHistory) Set(val *ExportSmsHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportSmsHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportSmsHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportSmsHistory(val *ExportSmsHistory) *NullableExportSmsHistory {
	return &NullableExportSmsHistory{value: val, isSet: true}
}

func (v NullableExportSmsHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportSmsHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
