...
// checks if the ViewVoiceLanguages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewVoiceLanguages{}

// ViewVoiceLanguages struct for ViewVoiceLanguages
type ViewVoiceLanguages struct {
	...
	Data []ViewVoiceLanguagesDataInner `json:"data,omitempty"`
}
...
func (o *ViewVoiceLanguages) GetData() []ViewVoiceLanguagesDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ViewVoiceLanguagesDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ViewVoiceLanguagesDataInner and assigns it to the Data field.
func (o *ViewVoiceLanguages) SetData(v []ViewVoiceLanguagesDataInner) {
	o.Data = v
}

func (o ViewVoiceLanguages) MarshalJSON() ([]byte, error) {
...
func (o ViewVoiceLanguages) ToMap() (map[string]interface{}, error) {
...
type NullableViewVoiceLanguages struct {
	value *ViewVoiceLanguages
	isSet bool
}

func (v NullableViewVoiceLanguages) Get() *ViewVoiceLanguages {
	return v.value
}

func (v *NullableViewVoiceLanguages) Set(val *ViewVoiceLanguages) {
	v.value = val
	v.isSet = true
}

func (v NullableViewVoiceLanguages) IsSet() bool {
	return v.isSet
}

func (v *NullableViewVoiceLanguages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewVoiceLanguages(val *ViewVoiceLanguages) *NullableViewVoiceLanguages {
	return &NullableViewVoiceLanguages{value: val, isSet: true}
}

func (v NullableViewVoiceLanguages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewVoiceLanguages) UnmarshalJSON(src []byte) error {
	v.isSet = true
