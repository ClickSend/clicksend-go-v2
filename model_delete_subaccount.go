...
// checks if the DeleteSubaccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSubaccount{}

// DeleteSubaccount struct for DeleteSubaccount
...
func (o DeleteSubaccount) MarshalJSON() ([]byte, error) {
...
func (o DeleteSubaccount) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteSubaccount struct {
	value *DeleteSubaccount
	isSet bool
}

func (v NullableDeleteSubaccount) Get() *DeleteSubaccount {
	return v.value
}

func (v *NullableDeleteSubaccount) Set(val *DeleteSubaccount) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSubaccount) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSubaccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSubaccount(val *DeleteSubaccount) *NullableDeleteSubaccount {
	return &NullableDeleteSubaccount{value: val, isSet: true}
}

func (v NullableDeleteSubaccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteSubaccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
