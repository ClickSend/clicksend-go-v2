...
// checks if the ViewASpecificSmsTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewASpecificSmsTemplate{}
...
type ViewASpecificSmsTemplate struct {
	...
	Data *ViewASpecificSmsTemplateData `json:"data,omitempty"`
}
...
func (o *ViewASpecificSmsTemplate) GetData() ViewASpecificSmsTemplateData {
	if o == nil || IsNil(o.Data) {
		var ret ViewASpecificSmsTemplateData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewASpecificSmsTemplateData and assigns it to the Data field.
func (o *ViewASpecificSmsTemplate) SetData(v ViewASpecificSmsTemplateData) {
	o.Data = &v
}

func (o ViewASpecificSmsTemplate) MarshalJSON() ([]byte, error) {
...
func (o ViewASpecificSmsTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableViewASpecificSmsTemplate struct {
	value *ViewASpecificSmsTemplate
	isSet bool
}

func (v NullableViewASpecificSmsTemplate) Get() *ViewASpecificSmsTemplate {
	return v.value
}

func (v *NullableViewASpecificSmsTemplate) Set(val *ViewASpecificSmsTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableViewASpecificSmsTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableViewASpecificSmsTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewASpecificSmsTemplate(val *ViewASpecificSmsTemplate) *NullableViewASpecificSmsTemplate {
	return &NullableViewASpecificSmsTemplate{value: val, isSet: true}
}

func (v NullableViewASpecificSmsTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewASpecificSmsTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
