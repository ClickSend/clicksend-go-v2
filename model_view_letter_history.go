...
// checks if the ViewLetterHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLetterHistory{}

// ViewLetterHistory struct for ViewLetterHistory
type ViewLetterHistory struct {
	...
	Data *ViewLetterHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewLetterHistoryData and assigns it to the Data field.
func (o *ViewLetterHistory) SetData(v ViewLetterHistoryData) {
	o.Data = &v
}

func (o ViewLetterHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewLetterHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewLetterHistory struct {
	value *ViewLetterHistory
	isSet bool
}

func (v NullableViewLetterHistory) Get() *ViewLetterHistory {
	return v.value
}

func (v *NullableViewLetterHistory) Set(val *ViewLetterHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLetterHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLetterHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLetterHistory(val *ViewLetterHistory) *NullableViewLetterHistory {
	return &NullableViewLetterHistory{value: val, isSet: true}
}

func (v NullableViewLetterHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLetterHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
