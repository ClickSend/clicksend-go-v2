...
// checks if the ViewSmsReceiptsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsReceiptsData{}

// ViewSmsReceiptsData The parameters related to the total message receipts shown. The response will depend on the pagination parameters, specified in the query parameters.
type ViewSmsReceiptsData struct {
...
func (o *ViewSmsReceiptsData) SetNextPageUrlNil() {
...
func (o *ViewSmsReceiptsData) SetPrevPageUrlNil() {
...
func (o ViewSmsReceiptsData) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsReceiptsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsReceiptsData struct {
	value *ViewSmsReceiptsData
	isSet bool
}

func (v NullableViewSmsReceiptsData) Get() *ViewSmsReceiptsData {
	return v.value
}

func (v *NullableViewSmsReceiptsData) Set(val *ViewSmsReceiptsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsReceiptsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsReceiptsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsReceiptsData(val *ViewSmsReceiptsData) *NullableViewSmsReceiptsData {
	return &NullableViewSmsReceiptsData{value: val, isSet: true}
}

func (v NullableViewSmsReceiptsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsReceiptsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
