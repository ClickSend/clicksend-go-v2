...
// checks if the DeleteStrippedStringRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteStrippedStringRule{}

// DeleteStrippedStringRule struct for DeleteStrippedStringRule
type DeleteStrippedStringRule struct {
...
func (o DeleteStrippedStringRule) MarshalJSON() ([]byte, error) {
...
func (o DeleteStrippedStringRule) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteStrippedStringRule struct {
	value *DeleteStrippedStringRule
	isSet bool
}

func (v NullableDeleteStrippedStringRule) Get() *DeleteStrippedStringRule {
	return v.value
}

func (v *NullableDeleteStrippedStringRule) Set(val *DeleteStrippedStringRule) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteStrippedStringRule) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteStrippedStringRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteStrippedStringRule(val *DeleteStrippedStringRule) *NullableDeleteStrippedStringRule {
	return &NullableDeleteStrippedStringRule{value: val, isSet: true}
}

func (v NullableDeleteStrippedStringRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteStrippedStringRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
