...
// checks if the ViewVoiceDeliveryReceiptRulesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewVoiceDeliveryReceiptRulesData{}

// ViewVoiceDeliveryReceiptRulesData struct for ViewVoiceDeliveryReceiptRulesData
type ViewVoiceDeliveryReceiptRulesData struct {
...
func NewViewVoiceDeliveryReceiptRulesData() *ViewVoiceDeliveryReceiptRulesData {
	this := ViewVoiceDeliveryReceiptRulesData{}
	return &this
}
...
func (o *ViewVoiceDeliveryReceiptRulesData) SetNextPageUrlNil() {
...
func (o *ViewVoiceDeliveryReceiptRulesData) SetPrevPageUrlNil() {
...
func (o ViewVoiceDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
...
func (o ViewVoiceDeliveryReceiptRulesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewVoiceDeliveryReceiptRulesData struct {
	value *ViewVoiceDeliveryReceiptRulesData
	isSet bool
}

func (v NullableViewVoiceDeliveryReceiptRulesData) Get() *ViewVoiceDeliveryReceiptRulesData {
	return v.value
}

func (v *NullableViewVoiceDeliveryReceiptRulesData) Set(val *ViewVoiceDeliveryReceiptRulesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewVoiceDeliveryReceiptRulesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewVoiceDeliveryReceiptRulesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewVoiceDeliveryReceiptRulesData(val *ViewVoiceDeliveryReceiptRulesData) *NullableViewVoiceDeliveryReceiptRulesData {
	return &NullableViewVoiceDeliveryReceiptRulesData{value: val, isSet: true}
}

func (v NullableViewVoiceDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewVoiceDeliveryReceiptRulesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
