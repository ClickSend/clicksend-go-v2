...
// checks if the ViewCountries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewCountries{}

// ViewCountries struct for ViewCountries
type ViewCountries struct {
...
func (o ViewCountries) MarshalJSON() ([]byte, error) {
...
func (o ViewCountries) ToMap() (map[string]interface{}, error) {
...
type NullableViewCountries struct {
	value *ViewCountries
	isSet bool
}

func (v NullableViewCountries) Get() *ViewCountries {
	return v.value
}

func (v *NullableViewCountries) Set(val *ViewCountries) {
	v.value = val
	v.isSet = true
}

func (v NullableViewCountries) IsSet() bool {
	return v.isSet
}

func (v *NullableViewCountries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewCountries(val *ViewCountries) *NullableViewCountries {
	return &NullableViewCountries{value: val, isSet: true}
}

func (v NullableViewCountries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewCountries) UnmarshalJSON(src []byte) error {
	v.isSet = true
