...
// checks if the ViewAllowedEmails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllowedEmails{}

// ViewAllowedEmails struct for ViewAllowedEmails
type ViewAllowedEmails struct {
	...
	Data *ViewAllowedEmailsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewAllowedEmailsData and assigns it to the Data field.
func (o *ViewAllowedEmails) SetData(v ViewAllowedEmailsData) {
	o.Data = &v
}

func (o ViewAllowedEmails) MarshalJSON() ([]byte, error) {
...
func (o ViewAllowedEmails) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllowedEmails struct {
	value *ViewAllowedEmails
	isSet bool
}

func (v NullableViewAllowedEmails) Get() *ViewAllowedEmails {
	return v.value
}

func (v *NullableViewAllowedEmails) Set(val *ViewAllowedEmails) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllowedEmails) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllowedEmails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllowedEmails(val *ViewAllowedEmails) *NullableViewAllowedEmails {
	return &NullableViewAllowedEmails{value: val, isSet: true}
}

func (v NullableViewAllowedEmails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllowedEmails) UnmarshalJSON(src []byte) error {
	v.isSet = true
