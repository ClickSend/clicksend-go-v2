...
// checks if the ViewFaxInboundRulesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxInboundRulesData{}

// ViewFaxInboundRulesData struct for ViewFaxInboundRulesData
type ViewFaxInboundRulesData struct {
...
func (o *ViewFaxInboundRulesData) SetNextPageUrlNil() {
...
func (o *ViewFaxInboundRulesData) SetPrevPageUrlNil() {
...
func (o ViewFaxInboundRulesData) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxInboundRulesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxInboundRulesData struct {
	value *ViewFaxInboundRulesData
	isSet bool
}

func (v NullableViewFaxInboundRulesData) Get() *ViewFaxInboundRulesData {
	return v.value
}

func (v *NullableViewFaxInboundRulesData) Set(val *ViewFaxInboundRulesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxInboundRulesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxInboundRulesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxInboundRulesData(val *ViewFaxInboundRulesData) *NullableViewFaxInboundRulesData {
	return &NullableViewFaxInboundRulesData{value: val, isSet: true}
}

func (v NullableViewFaxInboundRulesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxInboundRulesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
