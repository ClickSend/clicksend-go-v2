...
// checks if the UpdatePaymentInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePaymentInfo{}

// UpdatePaymentInfo struct for UpdatePaymentInfo
type UpdatePaymentInfo struct {
	...
	Data *UpdatePaymentInfoData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given UpdatePaymentInfoData and assigns it to the Data field.
func (o *UpdatePaymentInfo) SetData(v UpdatePaymentInfoData) {
	o.Data = &v
}

func (o UpdatePaymentInfo) MarshalJSON() ([]byte, error) {
...
func (o UpdatePaymentInfo) ToMap() (map[string]interface{}, error) {
...
type NullableUpdatePaymentInfo struct {
	value *UpdatePaymentInfo
	isSet bool
}

func (v NullableUpdatePaymentInfo) Get() *UpdatePaymentInfo {
	return v.value
}

func (v *NullableUpdatePaymentInfo) Set(val *UpdatePaymentInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePaymentInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePaymentInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePaymentInfo(val *UpdatePaymentInfo) *NullableUpdatePaymentInfo {
	return &NullableUpdatePaymentInfo{value: val, isSet: true}
}

func (v NullableUpdatePaymentInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePaymentInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
