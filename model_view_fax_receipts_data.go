...
// checks if the ViewFaxReceiptsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxReceiptsData{}

// ViewFaxReceiptsData struct for ViewFaxReceiptsData
type ViewFaxReceiptsData struct {
	...
	Data []FaxReceipt `json:"data,omitempty"`
}
...
func (o *ViewFaxReceiptsData) SetNextPageUrlNil() {
...
func (o *ViewFaxReceiptsData) SetPrevPageUrlNil() {
...
// SetData gets a reference to the given []FaxReceipt and assigns it to the Data field.
func (o *ViewFaxReceiptsData) SetData(v []FaxReceipt) {
	o.Data = v
}

func (o ViewFaxReceiptsData) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxReceiptsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxReceiptsData struct {
	value *ViewFaxReceiptsData
	isSet bool
}

func (v NullableViewFaxReceiptsData) Get() *ViewFaxReceiptsData {
	return v.value
}

func (v *NullableViewFaxReceiptsData) Set(val *ViewFaxReceiptsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxReceiptsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxReceiptsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxReceiptsData(val *ViewFaxReceiptsData) *NullableViewFaxReceiptsData {
	return &NullableViewFaxReceiptsData{value: val, isSet: true}
}

func (v NullableViewFaxReceiptsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxReceiptsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
