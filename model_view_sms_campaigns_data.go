...
// checks if the ViewSmsCampaignsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsCampaignsData{}

// ViewSmsCampaignsData The parameters related to the total SMS campaign shown. The response will depend on the query parameters.
type ViewSmsCampaignsData struct {
...
func (o *ViewSmsCampaignsData) SetNextPageUrlNil() {
...
func (o *ViewSmsCampaignsData) SetPrevPageUrlNil() {
...
func (o ViewSmsCampaignsData) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsCampaignsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsCampaignsData struct {
	value *ViewSmsCampaignsData
	isSet bool
}

func (v NullableViewSmsCampaignsData) Get() *ViewSmsCampaignsData {
	return v.value
}

func (v *NullableViewSmsCampaignsData) Set(val *ViewSmsCampaignsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsCampaignsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsCampaignsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsCampaignsData(val *ViewSmsCampaignsData) *NullableViewSmsCampaignsData {
	return &NullableViewSmsCampaignsData{value: val, isSet: true}
}

func (v NullableViewSmsCampaignsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsCampaignsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
