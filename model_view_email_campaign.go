...
// checks if the ViewEmailCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailCampaign{}

// ViewEmailCampaign struct for ViewEmailCampaign
type ViewEmailCampaign struct {
...
func (o ViewEmailCampaign) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailCampaign struct {
	value *ViewEmailCampaign
	isSet bool
}

func (v NullableViewEmailCampaign) Get() *ViewEmailCampaign {
	return v.value
}

func (v *NullableViewEmailCampaign) Set(val *ViewEmailCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailCampaign(val *ViewEmailCampaign) *NullableViewEmailCampaign {
	return &NullableViewEmailCampaign{value: val, isSet: true}
}

func (v NullableViewEmailCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
