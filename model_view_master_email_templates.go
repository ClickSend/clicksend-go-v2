...
// checks if the ViewMasterEmailTemplates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewMasterEmailTemplates{}

// ViewMasterEmailTemplates struct for ViewMasterEmailTemplates
type ViewMasterEmailTemplates struct {
...
func (o ViewMasterEmailTemplates) MarshalJSON() ([]byte, error) {
...
func (o ViewMasterEmailTemplates) ToMap() (map[string]interface{}, error) {
...
type NullableViewMasterEmailTemplates struct {
	value *ViewMasterEmailTemplates
	isSet bool
}

func (v NullableViewMasterEmailTemplates) Get() *ViewMasterEmailTemplates {
	return v.value
}

func (v *NullableViewMasterEmailTemplates) Set(val *ViewMasterEmailTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableViewMasterEmailTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableViewMasterEmailTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewMasterEmailTemplates(val *ViewMasterEmailTemplates) *NullableViewMasterEmailTemplates {
	return &NullableViewMasterEmailTemplates{value: val, isSet: true}
}

func (v NullableViewMasterEmailTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewMasterEmailTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
