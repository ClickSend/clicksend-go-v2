...
// checks if the ViewStrippedStringRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewStrippedStringRules{}

// ViewStrippedStringRules struct for ViewStrippedStringRules
type ViewStrippedStringRules struct {
	...
	Data *ViewStrippedStringRulesData `json:"data,omitempty"`
}
...
func (o *ViewStrippedStringRules) GetData() ViewStrippedStringRulesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewStrippedStringRulesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewStrippedStringRulesData and assigns it to the Data field.
func (o *ViewStrippedStringRules) SetData(v ViewStrippedStringRulesData) {
	o.Data = &v
}

func (o ViewStrippedStringRules) MarshalJSON() ([]byte, error) {
...
func (o ViewStrippedStringRules) ToMap() (map[string]interface{}, error) {
...
type NullableViewStrippedStringRules struct {
	value *ViewStrippedStringRules
	isSet bool
}

func (v NullableViewStrippedStringRules) Get() *ViewStrippedStringRules {
	return v.value
}

func (v *NullableViewStrippedStringRules) Set(val *ViewStrippedStringRules) {
	v.value = val
	v.isSet = true
}

func (v NullableViewStrippedStringRules) IsSet() bool {
	return v.isSet
}

func (v *NullableViewStrippedStringRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewStrippedStringRules(val *ViewStrippedStringRules) *NullableViewStrippedStringRules {
	return &NullableViewStrippedStringRules{value: val, isSet: true}
}

func (v NullableViewStrippedStringRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewStrippedStringRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
