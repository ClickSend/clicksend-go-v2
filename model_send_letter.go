...
// checks if the SendLetter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendLetter{}

// SendLetter struct for SendLetter
type SendLetter struct {
	...
	Data *SendLetterData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given SendLetterData and assigns it to the Data field.
func (o *SendLetter) SetData(v SendLetterData) {
	o.Data = &v
}

func (o SendLetter) MarshalJSON() ([]byte, error) {
...
func (o SendLetter) ToMap() (map[string]interface{}, error) {
...
type NullableSendLetter struct {
	value *SendLetter
	isSet bool
}

func (v NullableSendLetter) Get() *SendLetter {
	return v.value
}

func (v *NullableSendLetter) Set(val *SendLetter) {
	v.value = val
	v.isSet = true
}

func (v NullableSendLetter) IsSet() bool {
	return v.isSet
}

func (v *NullableSendLetter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendLetter(val *SendLetter) *NullableSendLetter {
	return &NullableSendLetter{value: val, isSet: true}
}

func (v NullableSendLetter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendLetter) UnmarshalJSON(src []byte) error {
	v.isSet = true
