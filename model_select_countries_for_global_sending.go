...
// checks if the SelectCountriesForGlobalSending type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelectCountriesForGlobalSending{}

// SelectCountriesForGlobalSending struct for SelectCountriesForGlobalSending
type SelectCountriesForGlobalSending struct {
...
func NewSelectCountriesForGlobalSending() *SelectCountriesForGlobalSending {
	this := SelectCountriesForGlobalSending{}
	return &this
}
...
func (o SelectCountriesForGlobalSending) MarshalJSON() ([]byte, error) {
...
func (o SelectCountriesForGlobalSending) ToMap() (map[string]interface{}, error) {
...
type NullableSelectCountriesForGlobalSending struct {
	value *SelectCountriesForGlobalSending
	isSet bool
}

func (v NullableSelectCountriesForGlobalSending) Get() *SelectCountriesForGlobalSending {
	return v.value
}

func (v *NullableSelectCountriesForGlobalSending) Set(val *SelectCountriesForGlobalSending) {
	v.value = val
	v.isSet = true
}

func (v NullableSelectCountriesForGlobalSending) IsSet() bool {
	return v.isSet
}

func (v *NullableSelectCountriesForGlobalSending) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSelectCountriesForGlobalSending(val *SelectCountriesForGlobalSending) *NullableSelectCountriesForGlobalSending {
	return &NullableSelectCountriesForGlobalSending{value: val, isSet: true}
}

func (v NullableSelectCountriesForGlobalSending) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSelectCountriesForGlobalSending) UnmarshalJSON(src []byte) error {
	v.isSet = true
