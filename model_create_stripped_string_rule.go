...
// checks if the CreateStrippedStringRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStrippedStringRule{}

// CreateStrippedStringRule struct for CreateStrippedStringRule
type CreateStrippedStringRule struct {
...
func (o CreateStrippedStringRule) MarshalJSON() ([]byte, error) {
...
func (o CreateStrippedStringRule) ToMap() (map[string]interface{}, error) {
...
type NullableCreateStrippedStringRule struct {
	value *CreateStrippedStringRule
	isSet bool
}

func (v NullableCreateStrippedStringRule) Get() *CreateStrippedStringRule {
	return v.value
}

func (v *NullableCreateStrippedStringRule) Set(val *CreateStrippedStringRule) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateStrippedStringRule) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateStrippedStringRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateStrippedStringRule(val *CreateStrippedStringRule) *NullableCreateStrippedStringRule {
	return &NullableCreateStrippedStringRule{value: val, isSet: true}
}

func (v NullableCreateStrippedStringRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateStrippedStringRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
