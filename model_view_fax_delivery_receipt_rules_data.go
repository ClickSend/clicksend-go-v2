...
// checks if the ViewFaxDeliveryReceiptRulesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxDeliveryReceiptRulesData{}

// ViewFaxDeliveryReceiptRulesData struct for ViewFaxDeliveryReceiptRulesData
type ViewFaxDeliveryReceiptRulesData struct {
...
func NewViewFaxDeliveryReceiptRulesData() *ViewFaxDeliveryReceiptRulesData {
	this := ViewFaxDeliveryReceiptRulesData{}
	return &this
}
...
func (o *ViewFaxDeliveryReceiptRulesData) SetNextPageUrlNil() {
...
func (o *ViewFaxDeliveryReceiptRulesData) SetPrevPageUrlNil() {
...
func (o ViewFaxDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxDeliveryReceiptRulesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxDeliveryReceiptRulesData struct {
	value *ViewFaxDeliveryReceiptRulesData
	isSet bool
}

func (v NullableViewFaxDeliveryReceiptRulesData) Get() *ViewFaxDeliveryReceiptRulesData {
	return v.value
}

func (v *NullableViewFaxDeliveryReceiptRulesData) Set(val *ViewFaxDeliveryReceiptRulesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxDeliveryReceiptRulesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxDeliveryReceiptRulesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxDeliveryReceiptRulesData(val *ViewFaxDeliveryReceiptRulesData) *NullableViewFaxDeliveryReceiptRulesData {
	return &NullableViewFaxDeliveryReceiptRulesData{value: val, isSet: true}
}

func (v NullableViewFaxDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxDeliveryReceiptRulesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
