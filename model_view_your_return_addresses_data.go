...
// checks if the ViewYourReturnAddressesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewYourReturnAddressesData{}

// ViewYourReturnAddressesData struct for ViewYourReturnAddressesData
type ViewYourReturnAddressesData struct {
...
func NewViewYourReturnAddressesData() *ViewYourReturnAddressesData {
	this := ViewYourReturnAddressesData{}
	return &this
}
...
func (o *ViewYourReturnAddressesData) SetNextPageUrlNil() {
...
func (o *ViewYourReturnAddressesData) SetPrevPageUrlNil() {
...
func (o ViewYourReturnAddressesData) MarshalJSON() ([]byte, error) {
...
func (o ViewYourReturnAddressesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewYourReturnAddressesData struct {
	value *ViewYourReturnAddressesData
	isSet bool
}

func (v NullableViewYourReturnAddressesData) Get() *ViewYourReturnAddressesData {
	return v.value
}

func (v *NullableViewYourReturnAddressesData) Set(val *ViewYourReturnAddressesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewYourReturnAddressesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewYourReturnAddressesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewYourReturnAddressesData(val *ViewYourReturnAddressesData) *NullableViewYourReturnAddressesData {
	return &NullableViewYourReturnAddressesData{value: val, isSet: true}
}

func (v NullableViewYourReturnAddressesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewYourReturnAddressesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
