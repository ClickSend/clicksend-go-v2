...
// checks if the GetVoiceHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVoiceHistory{}

// GetVoiceHistory struct for GetVoiceHistory
type GetVoiceHistory struct {
	...
	Data *GetVoiceHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given GetVoiceHistoryData and assigns it to the Data field.
func (o *GetVoiceHistory) SetData(v GetVoiceHistoryData) {
	o.Data = &v
}

func (o GetVoiceHistory) MarshalJSON() ([]byte, error) {
...
func (o GetVoiceHistory) ToMap() (map[string]interface{}, error) {
...
type NullableGetVoiceHistory struct {
	value *GetVoiceHistory
	isSet bool
}

func (v NullableGetVoiceHistory) Get() *GetVoiceHistory {
	return v.value
}

func (v *NullableGetVoiceHistory) Set(val *GetVoiceHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVoiceHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVoiceHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVoiceHistory(val *GetVoiceHistory) *NullableGetVoiceHistory {
	return &NullableGetVoiceHistory{value: val, isSet: true}
}

func (v NullableGetVoiceHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVoiceHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
