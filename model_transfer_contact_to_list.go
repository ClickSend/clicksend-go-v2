...
// checks if the TransferContactToList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransferContactToList{}

// TransferContactToList struct for TransferContactToList
type TransferContactToList struct {
...
func (o TransferContactToList) MarshalJSON() ([]byte, error) {
...
func (o TransferContactToList) ToMap() (map[string]interface{}, error) {
...
type NullableTransferContactToList struct {
	value *TransferContactToList
	isSet bool
}

func (v NullableTransferContactToList) Get() *TransferContactToList {
	return v.value
}

func (v *NullableTransferContactToList) Set(val *TransferContactToList) {
	v.value = val
	v.isSet = true
}

func (v NullableTransferContactToList) IsSet() bool {
	return v.isSet
}

func (v *NullableTransferContactToList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransferContactToList(val *TransferContactToList) *NullableTransferContactToList {
	return &NullableTransferContactToList{value: val, isSet: true}
}

func (v NullableTransferContactToList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransferContactToList) UnmarshalJSON(src []byte) error {
	v.isSet = true
