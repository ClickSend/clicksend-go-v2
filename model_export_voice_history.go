...
// checks if the ExportVoiceHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportVoiceHistory{}

// ExportVoiceHistory struct for ExportVoiceHistory
type ExportVoiceHistory struct {
...
func (o ExportVoiceHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportVoiceHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportVoiceHistory struct {
	value *ExportVoiceHistory
	isSet bool
}

func (v NullableExportVoiceHistory) Get() *ExportVoiceHistory {
	return v.value
}

func (v *NullableExportVoiceHistory) Set(val *ExportVoiceHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportVoiceHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportVoiceHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportVoiceHistory(val *ExportVoiceHistory) *NullableExportVoiceHistory {
	return &NullableExportVoiceHistory{value: val, isSet: true}
}

func (v NullableExportVoiceHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportVoiceHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
