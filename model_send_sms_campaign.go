...
// checks if the SendSmsCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendSmsCampaign{}

// SendSmsCampaign struct for SendSmsCampaign
type SendSmsCampaign struct {
...
func (o SendSmsCampaign) MarshalJSON() ([]byte, error) {
...
func (o SendSmsCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableSendSmsCampaign struct {
	value *SendSmsCampaign
	isSet bool
}

func (v NullableSendSmsCampaign) Get() *SendSmsCampaign {
	return v.value
}

func (v *NullableSendSmsCampaign) Set(val *SendSmsCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableSendSmsCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableSendSmsCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendSmsCampaign(val *SendSmsCampaign) *NullableSendSmsCampaign {
	return &NullableSendSmsCampaign{value: val, isSet: true}
}

func (v NullableSendSmsCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendSmsCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
