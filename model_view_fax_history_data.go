...
// checks if the ViewFaxHistoryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxHistoryData{}

// ViewFaxHistoryData struct for ViewFaxHistoryData
type ViewFaxHistoryData struct {
...
func (o *ViewFaxHistoryData) SetNextPageUrlNil() {
...
func (o *ViewFaxHistoryData) SetPrevPageUrlNil() {
...
func (o ViewFaxHistoryData) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxHistoryData) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxHistoryData struct {
	value *ViewFaxHistoryData
	isSet bool
}

func (v NullableViewFaxHistoryData) Get() *ViewFaxHistoryData {
	return v.value
}

func (v *NullableViewFaxHistoryData) Set(val *ViewFaxHistoryData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxHistoryData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxHistoryData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxHistoryData(val *ViewFaxHistoryData) *NullableViewFaxHistoryData {
	return &NullableViewFaxHistoryData{value: val, isSet: true}
}

func (v NullableViewFaxHistoryData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxHistoryData) UnmarshalJSON(src []byte) error {
	v.isSet = true
