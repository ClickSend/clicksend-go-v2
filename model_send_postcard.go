...
// checks if the SendPostcard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendPostcard{}

// SendPostcard struct for SendPostcard
type SendPostcard struct {
...
func (o SendPostcard) MarshalJSON() ([]byte, error) {
...
func (o SendPostcard) ToMap() (map[string]interface{}, error) {
...
type NullableSendPostcard struct {
	value *SendPostcard
	isSet bool
}

func (v NullableSendPostcard) Get() *SendPostcard {
	return v.value
}

func (v *NullableSendPostcard) Set(val *SendPostcard) {
	v.value = val
	v.isSet = true
}

func (v NullableSendPostcard) IsSet() bool {
	return v.isSet
}

func (v *NullableSendPostcard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendPostcard(val *SendPostcard) *NullableSendPostcard {
	return &NullableSendPostcard{value: val, isSet: true}
}

func (v NullableSendPostcard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendPostcard) UnmarshalJSON(src []byte) error {
	v.isSet = true
