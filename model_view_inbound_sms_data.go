...
// checks if the ViewInboundSmsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewInboundSmsData{}

// ViewInboundSmsData struct for ViewInboundSmsData
type ViewInboundSmsData struct {
...
func (o *ViewInboundSmsData) SetNextPageUrlNil() {
...
func (o *ViewInboundSmsData) SetPrevPageUrlNil() {
...
func (o ViewInboundSmsData) MarshalJSON() ([]byte, error) {
...
func (o ViewInboundSmsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewInboundSmsData struct {
	value *ViewInboundSmsData
	isSet bool
}

func (v NullableViewInboundSmsData) Get() *ViewInboundSmsData {
	return v.value
}

func (v *NullableViewInboundSmsData) Set(val *ViewInboundSmsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewInboundSmsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewInboundSmsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewInboundSmsData(val *ViewInboundSmsData) *NullableViewInboundSmsData {
	return &NullableViewInboundSmsData{value: val, isSet: true}
}

func (v NullableViewInboundSmsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewInboundSmsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
