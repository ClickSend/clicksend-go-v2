...
// checks if the UpdateSmsTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSmsTemplate{}

// UpdateSmsTemplate struct for UpdateSmsTemplate
type UpdateSmsTemplate struct {
	...
	Data *SmsTemplateUpdate `json:"data,omitempty"`
}
...
// SetData gets a reference to the given SmsTemplateUpdate and assigns it to the Data field.
func (o *UpdateSmsTemplate) SetData(v SmsTemplateUpdate) {
	o.Data = &v
}

func (o UpdateSmsTemplate) MarshalJSON() ([]byte, error) {
...
func (o UpdateSmsTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSmsTemplate struct {
	value *UpdateSmsTemplate
	isSet bool
}

func (v NullableUpdateSmsTemplate) Get() *UpdateSmsTemplate {
	return v.value
}

func (v *NullableUpdateSmsTemplate) Set(val *UpdateSmsTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSmsTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSmsTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSmsTemplate(val *UpdateSmsTemplate) *NullableUpdateSmsTemplate {
	return &NullableUpdateSmsTemplate{value: val, isSet: true}
}

func (v NullableUpdateSmsTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSmsTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
