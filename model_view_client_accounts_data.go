...
// checks if the ViewClientAccountsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewClientAccountsData{}

// ViewClientAccountsData struct for ViewClientAccountsData
type ViewClientAccountsData struct {
	...
	Data []ResellerAccount `json:"data,omitempty"`
...
func (o *ViewClientAccountsData) SetNextPageUrlNil() {
...
func (o *ViewClientAccountsData) SetPrevPageUrlNil() {
...
// SetData gets a reference to the given []ResellerAccount and assigns it to the Data field.
...
func (o ViewClientAccountsData) MarshalJSON() ([]byte, error) {
...
func (o ViewClientAccountsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewClientAccountsData struct {
	value *ViewClientAccountsData
	isSet bool
}

func (v NullableViewClientAccountsData) Get() *ViewClientAccountsData {
	return v.value
}

func (v *NullableViewClientAccountsData) Set(val *ViewClientAccountsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewClientAccountsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewClientAccountsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewClientAccountsData(val *ViewClientAccountsData) *NullableViewClientAccountsData {
	return &NullableViewClientAccountsData{value: val, isSet: true}
}

func (v NullableViewClientAccountsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewClientAccountsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
