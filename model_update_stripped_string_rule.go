...
// checks if the UpdateStrippedStringRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateStrippedStringRule{}

// UpdateStrippedStringRule struct for UpdateStrippedStringRule
type UpdateStrippedStringRule struct {
...
func (o UpdateStrippedStringRule) MarshalJSON() ([]byte, error) {
...
func (o UpdateStrippedStringRule) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateStrippedStringRule struct {
	value *UpdateStrippedStringRule
	isSet bool
}

func (v NullableUpdateStrippedStringRule) Get() *UpdateStrippedStringRule {
	return v.value
}

func (v *NullableUpdateStrippedStringRule) Set(val *UpdateStrippedStringRule) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateStrippedStringRule) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateStrippedStringRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateStrippedStringRule(val *UpdateStrippedStringRule) *NullableUpdateStrippedStringRule {
	return &NullableUpdateStrippedStringRule{value: val, isSet: true}
}

func (v NullableUpdateStrippedStringRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateStrippedStringRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
