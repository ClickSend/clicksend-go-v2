...
// checks if the CancelMmsCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelMmsCampaign{}

// CancelMmsCampaign struct for CancelMmsCampaign
type CancelMmsCampaign struct {
...
func (o CancelMmsCampaign) MarshalJSON() ([]byte, error) {
...
func (o CancelMmsCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableCancelMmsCampaign struct {
	value *CancelMmsCampaign
	isSet bool
}

func (v NullableCancelMmsCampaign) Get() *CancelMmsCampaign {
	return v.value
}

func (v *NullableCancelMmsCampaign) Set(val *CancelMmsCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelMmsCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelMmsCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelMmsCampaign(val *CancelMmsCampaign) *NullableCancelMmsCampaign {
	return &NullableCancelMmsCampaign{value: val, isSet: true}
}

func (v NullableCancelMmsCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelMmsCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
