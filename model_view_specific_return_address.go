...
// checks if the ViewSpecificReturnAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSpecificReturnAddress{}

// ViewSpecificReturnAddress struct for ViewSpecificReturnAddress
type ViewSpecificReturnAddress struct {
...
func NewViewSpecificReturnAddress() *ViewSpecificReturnAddress {
	this := ViewSpecificReturnAddress{}
	return &this
}
...
func (o ViewSpecificReturnAddress) MarshalJSON() ([]byte, error) {
...
func (o ViewSpecificReturnAddress) ToMap() (map[string]interface{}, error) {
...
type NullableViewSpecificReturnAddress struct {
	value *ViewSpecificReturnAddress
	isSet bool
}

func (v NullableViewSpecificReturnAddress) Get() *ViewSpecificReturnAddress {
	return v.value
}

func (v *NullableViewSpecificReturnAddress) Set(val *ViewSpecificReturnAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSpecificReturnAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSpecificReturnAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSpecificReturnAddress(val *ViewSpecificReturnAddress) *NullableViewSpecificReturnAddress {
	return &NullableViewSpecificReturnAddress{value: val, isSet: true}
}

func (v NullableViewSpecificReturnAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSpecificReturnAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
