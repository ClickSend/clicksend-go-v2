...
// checks if the CreateSmsTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSmsTemplate{}

// CreateSmsTemplate struct for CreateSmsTemplate
type CreateSmsTemplate struct {
...
func (o CreateSmsTemplate) MarshalJSON() ([]byte, error) {
...
func (o CreateSmsTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSmsTemplate struct {
	value *CreateSmsTemplate
	isSet bool
}

func (v NullableCreateSmsTemplate) Get() *CreateSmsTemplate {
	return v.value
}

func (v *NullableCreateSmsTemplate) Set(val *CreateSmsTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSmsTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSmsTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSmsTemplate(val *CreateSmsTemplate) *NullableCreateSmsTemplate {
	return &NullableCreateSmsTemplate{value: val, isSet: true}
}

func (v NullableCreateSmsTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSmsTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
