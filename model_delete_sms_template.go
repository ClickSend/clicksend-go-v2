...
// checks if the DeleteSmsTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSmsTemplate{}

// DeleteSmsTemplate struct for DeleteSmsTemplate
type DeleteSmsTemplate struct {
...
func (o DeleteSmsTemplate) MarshalJSON() ([]byte, error) {
...
func (o DeleteSmsTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteSmsTemplate struct {
	value *DeleteSmsTemplate
	isSet bool
}

func (v NullableDeleteSmsTemplate) Get() *DeleteSmsTemplate {
	return v.value
}

func (v *NullableDeleteSmsTemplate) Set(val *DeleteSmsTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSmsTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSmsTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSmsTemplate(val *DeleteSmsTemplate) *NullableDeleteSmsTemplate {
	return &NullableDeleteSmsTemplate{value: val, isSet: true}
}

func (v NullableDeleteSmsTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteSmsTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
