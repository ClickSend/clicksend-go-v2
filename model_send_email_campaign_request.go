...
// checks if the SendEmailCampaignRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendEmailCampaignRequest{}

// SendEmailCampaignRequest struct for SendEmailCampaignRequest
...
func (o SendEmailCampaignRequest) MarshalJSON() ([]byte, error) {
...
func (o SendEmailCampaignRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSendEmailCampaignRequest struct {
	value *SendEmailCampaignRequest
	isSet bool
}

func (v NullableSendEmailCampaignRequest) Get() *SendEmailCampaignRequest {
	return v.value
}

func (v *NullableSendEmailCampaignRequest) Set(val *SendEmailCampaignRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendEmailCampaignRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendEmailCampaignRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendEmailCampaignRequest(val *SendEmailCampaignRequest) *NullableSendEmailCampaignRequest {
	return &NullableSendEmailCampaignRequest{value: val, isSet: true}
}

func (v NullableSendEmailCampaignRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendEmailCampaignRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
