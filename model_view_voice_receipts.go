...
// checks if the ViewVoiceReceipts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewVoiceReceipts{}

// ViewVoiceReceipts struct for ViewVoiceReceipts
type ViewVoiceReceipts struct {
	...
	Data *ViewVoiceReceiptsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewVoiceReceiptsData and assigns it to the Data field.
func (o *ViewVoiceReceipts) SetData(v ViewVoiceReceiptsData) {
	o.Data = &v
}

func (o ViewVoiceReceipts) MarshalJSON() ([]byte, error) {
...
func (o ViewVoiceReceipts) ToMap() (map[string]interface{}, error) {
...
type NullableViewVoiceReceipts struct {
	value *ViewVoiceReceipts
	isSet bool
}

func (v NullableViewVoiceReceipts) Get() *ViewVoiceReceipts {
	return v.value
}

func (v *NullableViewVoiceReceipts) Set(val *ViewVoiceReceipts) {
	v.value = val
	v.isSet = true
}

func (v NullableViewVoiceReceipts) IsSet() bool {
	return v.isSet
}

func (v *NullableViewVoiceReceipts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewVoiceReceipts(val *ViewVoiceReceipts) *NullableViewVoiceReceipts {
	return &NullableViewVoiceReceipts{value: val, isSet: true}
}

func (v NullableViewVoiceReceipts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewVoiceReceipts) UnmarshalJSON(src []byte) error {
	v.isSet = true
