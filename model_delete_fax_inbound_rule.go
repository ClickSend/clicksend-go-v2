...
// checks if the DeleteFaxInboundRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteFaxInboundRule{}

// DeleteFaxInboundRule struct for DeleteFaxInboundRule
type DeleteFaxInboundRule struct {
...
func (o DeleteFaxInboundRule) MarshalJSON() ([]byte, error) {
...
func (o DeleteFaxInboundRule) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteFaxInboundRule struct {
	value *DeleteFaxInboundRule
	isSet bool
}

func (v NullableDeleteFaxInboundRule) Get() *DeleteFaxInboundRule {
	return v.value
}

func (v *NullableDeleteFaxInboundRule) Set(val *DeleteFaxInboundRule) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteFaxInboundRule) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteFaxInboundRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteFaxInboundRule(val *DeleteFaxInboundRule) *NullableDeleteFaxInboundRule {
	return &NullableDeleteFaxInboundRule{value: val, isSet: true}
}

func (v NullableDeleteFaxInboundRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteFaxInboundRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
