...
// checks if the ExportPostcardHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportPostcardHistory{}

// ExportPostcardHistory struct for ExportPostcardHistory
type ExportPostcardHistory struct {
...
func (o ExportPostcardHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportPostcardHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportPostcardHistory struct {
	value *ExportPostcardHistory
	isSet bool
}

func (v NullableExportPostcardHistory) Get() *ExportPostcardHistory {
	return v.value
}

func (v *NullableExportPostcardHistory) Set(val *ExportPostcardHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportPostcardHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportPostcardHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportPostcardHistory(val *ExportPostcardHistory) *NullableExportPostcardHistory {
	return &NullableExportPostcardHistory{value: val, isSet: true}
}

func (v NullableExportPostcardHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportPostcardHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
