...
// checks if the ViewFaxInboundRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxInboundRules{}

// ViewFaxInboundRules struct for ViewFaxInboundRules
type ViewFaxInboundRules struct {
	...
	Data *ViewFaxInboundRulesData `json:"data,omitempty"`
}
...
func (o *ViewFaxInboundRules) GetData() ViewFaxInboundRulesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewFaxInboundRulesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewFaxInboundRulesData and assigns it to the Data field.
func (o *ViewFaxInboundRules) SetData(v ViewFaxInboundRulesData) {
	o.Data = &v
}

func (o ViewFaxInboundRules) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxInboundRules) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxInboundRules struct {
	value *ViewFaxInboundRules
	isSet bool
}

func (v NullableViewFaxInboundRules) Get() *ViewFaxInboundRules {
	return v.value
}

func (v *NullableViewFaxInboundRules) Set(val *ViewFaxInboundRules) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxInboundRules) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxInboundRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxInboundRules(val *ViewFaxInboundRules) *NullableViewFaxInboundRules {
	return &NullableViewFaxInboundRules{value: val, isSet: true}
}

func (v NullableViewFaxInboundRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxInboundRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
