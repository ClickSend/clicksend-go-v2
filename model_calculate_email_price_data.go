...
// checks if the CalculateEmailPriceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalculateEmailPriceData{}

// CalculateEmailPriceData struct for CalculateEmailPriceData
type CalculateEmailPriceData struct {
...
func (o *CalculateEmailPriceData) SetNextPageUrlNil() {
...
func (o *CalculateEmailPriceData) SetPrevPageUrlNil() {
...
func (o CalculateEmailPriceData) MarshalJSON() ([]byte, error) {
...
func (o CalculateEmailPriceData) ToMap() (map[string]interface{}, error) {
...
type NullableCalculateEmailPriceData struct {
	value *CalculateEmailPriceData
	isSet bool
}

func (v NullableCalculateEmailPriceData) Get() *CalculateEmailPriceData {
	return v.value
}

func (v *NullableCalculateEmailPriceData) Set(val *CalculateEmailPriceData) {
	v.value = val
	v.isSet = true
}

func (v NullableCalculateEmailPriceData) IsSet() bool {
	return v.isSet
}

func (v *NullableCalculateEmailPriceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalculateEmailPriceData(val *CalculateEmailPriceData) *NullableCalculateEmailPriceData {
	return &NullableCalculateEmailPriceData{value: val, isSet: true}
}

func (v NullableCalculateEmailPriceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalculateEmailPriceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
