...
// checks if the ViewYourNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewYourNumbers{}

// ViewYourNumbers struct for ViewYourNumbers
type ViewYourNumbers struct {
	...
	Data *ViewYourNumbersData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewYourNumbersData and assigns it to the Data field.
func (o *ViewYourNumbers) SetData(v ViewYourNumbersData) {
	o.Data = &v
}

func (o ViewYourNumbers) MarshalJSON() ([]byte, error) {
...
func (o ViewYourNumbers) ToMap() (map[string]interface{}, error) {
...
type NullableViewYourNumbers struct {
	value *ViewYourNumbers
	isSet bool
}

func (v NullableViewYourNumbers) Get() *ViewYourNumbers {
	return v.value
}

func (v *NullableViewYourNumbers) Set(val *ViewYourNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableViewYourNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableViewYourNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewYourNumbers(val *ViewYourNumbers) *NullableViewYourNumbers {
	return &NullableViewYourNumbers{value: val, isSet: true}
}

func (v NullableViewYourNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewYourNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
