...
// checks if the ExportLetterHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportLetterHistory{}

// ExportLetterHistory struct for ExportLetterHistory
type ExportLetterHistory struct {
	...
	Data *ExportSmsHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ExportSmsHistoryData and assigns it to the Data field.
func (o *ExportLetterHistory) SetData(v ExportSmsHistoryData) {
	o.Data = &v
}

func (o ExportLetterHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportLetterHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportLetterHistory struct {
	value *ExportLetterHistory
	isSet bool
}

func (v NullableExportLetterHistory) Get() *ExportLetterHistory {
	return v.value
}

func (v *NullableExportLetterHistory) Set(val *ExportLetterHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportLetterHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportLetterHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportLetterHistory(val *ExportLetterHistory) *NullableExportLetterHistory {
	return &NullableExportLetterHistory{value: val, isSet: true}
}

func (v NullableExportLetterHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportLetterHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
