...
// checks if the ViewListContacts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewListContacts{}

// ViewListContacts struct for ViewListContacts
type ViewListContacts struct {
...
func (o ViewListContacts) ToMap() (map[string]interface{}, error) {
...
type NullableViewListContacts struct {
	value *ViewListContacts
	isSet bool
}

func (v NullableViewListContacts) Get() *ViewListContacts {
	return v.value
}

func (v *NullableViewListContacts) Set(val *ViewListContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableViewListContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableViewListContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewListContacts(val *ViewListContacts) *NullableViewListContacts {
	return &NullableViewListContacts{value: val, isSet: true}
}

func (v NullableViewListContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewListContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
