...
// checks if the ViewSpecificSmsReceipt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSpecificSmsReceipt{}

// ViewSpecificSmsReceipt struct for ViewSpecificSmsReceipt
type ViewSpecificSmsReceipt struct {
	...
	Data *SmsReceipt `json:"data,omitempty"`
}
...
// SetData gets a reference to the given SmsReceipt and assigns it to the Data field.
func (o *ViewSpecificSmsReceipt) SetData(v SmsReceipt) {
	o.Data = &v
}

func (o ViewSpecificSmsReceipt) MarshalJSON() ([]byte, error) {
...
func (o ViewSpecificSmsReceipt) ToMap() (map[string]interface{}, error) {
...
type NullableViewSpecificSmsReceipt struct {
	value *ViewSpecificSmsReceipt
	isSet bool
}

func (v NullableViewSpecificSmsReceipt) Get() *ViewSpecificSmsReceipt {
	return v.value
}

func (v *NullableViewSpecificSmsReceipt) Set(val *ViewSpecificSmsReceipt) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSpecificSmsReceipt) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSpecificSmsReceipt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSpecificSmsReceipt(val *ViewSpecificSmsReceipt) *NullableViewSpecificSmsReceipt {
	return &NullableViewSpecificSmsReceipt{value: val, isSet: true}
}

func (v NullableViewSpecificSmsReceipt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSpecificSmsReceipt) UnmarshalJSON(src []byte) error {
	v.isSet = true
