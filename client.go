...
// APIClient manages communication with the SMS API v1.0.0
...
type APIClient struct {
	...
	AlphaTagsAPI *AlphaTagsAPIService

	ContactsAPI *ContactsAPIService

	DefaultSendersAPI *DefaultSendersAPIService
	...
	MessageDeliveryAPI *MessageDeliveryAPIService

	MmsAPI *MmsAPIService

	MmsCampaignsAPI *MmsCampaignsAPIService
	...
	UrlShorteningAPI *UrlShorteningAPIService

	VerificationAPI *VerificationAPIService

	VoiceAPI *VoiceAPIService

	VoiceMessagingAPI *VoiceMessagingAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.AlphaTagsAPI = (*AlphaTagsAPIService)(&c.common)
	...
	c.MmsAPI = (*MmsAPIService)(&c.common)
	...
	c.UrlShorteningAPI = (*UrlShorteningAPIService)(&c.common)
	c.VerificationAPI = (*VerificationAPIService)(&c.common)
	c.VoiceAPI = (*VoiceAPIService)(&c.common)
	c.VoiceMessagingAPI = (*VoiceMessagingAPIService)(&c.common)
