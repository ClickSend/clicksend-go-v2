...
// checks if the CancelEmailCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelEmailCampaign{}

// CancelEmailCampaign struct for CancelEmailCampaign
type CancelEmailCampaign struct {
...
func (o CancelEmailCampaign) MarshalJSON() ([]byte, error) {
...
func (o CancelEmailCampaign) ToMap() (map[string]interface{}, error) {
...
type NullableCancelEmailCampaign struct {
	value *CancelEmailCampaign
	isSet bool
}

func (v NullableCancelEmailCampaign) Get() *CancelEmailCampaign {
	return v.value
}

func (v *NullableCancelEmailCampaign) Set(val *CancelEmailCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelEmailCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelEmailCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelEmailCampaign(val *CancelEmailCampaign) *NullableCancelEmailCampaign {
	return &NullableCancelEmailCampaign{value: val, isSet: true}
}

func (v NullableCancelEmailCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelEmailCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
