...
// checks if the Timezones type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Timezones{}
...
func (o Timezones) ToMap() (map[string]interface{}, error) {
