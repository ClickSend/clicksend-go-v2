...
// checks if the CreateTestInboundSms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTestInboundSms{}

// CreateTestInboundSms struct for CreateTestInboundSms
type CreateTestInboundSms struct {
	...
	Data *InboundSmsTest `json:"data,omitempty"`
}
...
// SetData gets a reference to the given InboundSmsTest and assigns it to the Data field.
func (o *CreateTestInboundSms) SetData(v InboundSmsTest) {
	o.Data = &v
}

func (o CreateTestInboundSms) MarshalJSON() ([]byte, error) {
...
func (o CreateTestInboundSms) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTestInboundSms struct {
	value *CreateTestInboundSms
	isSet bool
}

func (v NullableCreateTestInboundSms) Get() *CreateTestInboundSms {
	return v.value
}

func (v *NullableCreateTestInboundSms) Set(val *CreateTestInboundSms) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTestInboundSms) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTestInboundSms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTestInboundSms(val *CreateTestInboundSms) *NullableCreateTestInboundSms {
	return &NullableCreateTestInboundSms{value: val, isSet: true}
}

func (v NullableCreateTestInboundSms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTestInboundSms) UnmarshalJSON(src []byte) error {
	v.isSet = true
