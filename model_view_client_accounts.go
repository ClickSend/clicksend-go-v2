...
// checks if the ViewClientAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewClientAccounts{}

// ViewClientAccounts struct for ViewClientAccounts
type ViewClientAccounts struct {
	...
	Data *ViewClientAccountsData `json:"data,omitempty"`
}
...
func (o *ViewClientAccounts) GetData() ViewClientAccountsData {
	if o == nil || IsNil(o.Data) {
		var ret ViewClientAccountsData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewClientAccountsData and assigns it to the Data field.
func (o *ViewClientAccounts) SetData(v ViewClientAccountsData) {
	o.Data = &v
}

func (o ViewClientAccounts) MarshalJSON() ([]byte, error) {
...
func (o ViewClientAccounts) ToMap() (map[string]interface{}, error) {
...
type NullableViewClientAccounts struct {
	value *ViewClientAccounts
	isSet bool
}

func (v NullableViewClientAccounts) Get() *ViewClientAccounts {
	return v.value
}

func (v *NullableViewClientAccounts) Set(val *ViewClientAccounts) {
	v.value = val
	v.isSet = true
}

func (v NullableViewClientAccounts) IsSet() bool {
	return v.isSet
}

func (v *NullableViewClientAccounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewClientAccounts(val *ViewClientAccounts) *NullableViewClientAccounts {
	return &NullableViewClientAccounts{value: val, isSet: true}
}

func (v NullableViewClientAccounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewClientAccounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
