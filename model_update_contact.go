...
// checks if the UpdateContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateContact{}
...
func (v NullableUpdateContact) Get() *UpdateContact {
	return v.value
}
...
func NewNullableUpdateContact(val *UpdateContact) *NullableUpdateContact {
	return &NullableUpdateContact{value: val, isSet: true}
}
