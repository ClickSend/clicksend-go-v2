...
// checks if the ViewSpecificClientAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSpecificClientAccount{}

// ViewSpecificClientAccount struct for ViewSpecificClientAccount
type ViewSpecificClientAccount struct {
...
func NewViewSpecificClientAccount() *ViewSpecificClientAccount {
	this := ViewSpecificClientAccount{}
	return &this
}
...
func (o ViewSpecificClientAccount) MarshalJSON() ([]byte, error) {
...
func (o ViewSpecificClientAccount) ToMap() (map[string]interface{}, error) {
...
type NullableViewSpecificClientAccount struct {
	value *ViewSpecificClientAccount
	isSet bool
}

func (v NullableViewSpecificClientAccount) Get() *ViewSpecificClientAccount {
	return v.value
}

func (v *NullableViewSpecificClientAccount) Set(val *ViewSpecificClientAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSpecificClientAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSpecificClientAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSpecificClientAccount(val *ViewSpecificClientAccount) *NullableViewSpecificClientAccount {
	return &NullableViewSpecificClientAccount{value: val, isSet: true}
}

func (v NullableViewSpecificClientAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSpecificClientAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
