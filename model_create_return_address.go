...
// checks if the CreateReturnAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateReturnAddress{}

// CreateReturnAddress struct for CreateReturnAddress
type CreateReturnAddress struct {
	...
	Data *PostReturnAddress `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PostReturnAddress and assigns it to the Data field.
func (o *CreateReturnAddress) SetData(v PostReturnAddress) {
	o.Data = &v
}

func (o CreateReturnAddress) MarshalJSON() ([]byte, error) {
...
func (o CreateReturnAddress) ToMap() (map[string]interface{}, error) {
...
type NullableCreateReturnAddress struct {
	value *CreateReturnAddress
	isSet bool
}

func (v NullableCreateReturnAddress) Get() *CreateReturnAddress {
	return v.value
}

func (v *NullableCreateReturnAddress) Set(val *CreateReturnAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateReturnAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateReturnAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateReturnAddress(val *CreateReturnAddress) *NullableCreateReturnAddress {
	return &NullableCreateReturnAddress{value: val, isSet: true}
}

func (v NullableCreateReturnAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateReturnAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
