...
// checks if the ViewVoiceReceiptsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewVoiceReceiptsData{}

// ViewVoiceReceiptsData struct for ViewVoiceReceiptsData
type ViewVoiceReceiptsData struct {
	...
	Data []VoiceReceipt `json:"data,omitempty"`
}
...
func (o *ViewVoiceReceiptsData) SetNextPageUrlNil() {
...
func (o *ViewVoiceReceiptsData) SetPrevPageUrlNil() {
...
// SetData gets a reference to the given []VoiceReceipt and assigns it to the Data field.
func (o *ViewVoiceReceiptsData) SetData(v []VoiceReceipt) {
	o.Data = v
}

func (o ViewVoiceReceiptsData) MarshalJSON() ([]byte, error) {
...
func (o ViewVoiceReceiptsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewVoiceReceiptsData struct {
	value *ViewVoiceReceiptsData
	isSet bool
}

func (v NullableViewVoiceReceiptsData) Get() *ViewVoiceReceiptsData {
	return v.value
}

func (v *NullableViewVoiceReceiptsData) Set(val *ViewVoiceReceiptsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewVoiceReceiptsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewVoiceReceiptsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewVoiceReceiptsData(val *ViewVoiceReceiptsData) *NullableViewVoiceReceiptsData {
	return &NullableViewVoiceReceiptsData{value: val, isSet: true}
}

func (v NullableViewVoiceReceiptsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewVoiceReceiptsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
