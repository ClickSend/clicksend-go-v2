...
// checks if the DeleteAllowedEmailAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteAllowedEmailAddress{}

// DeleteAllowedEmailAddress struct for DeleteAllowedEmailAddress
type DeleteAllowedEmailAddress struct {
...
func NewDeleteAllowedEmailAddress() *DeleteAllowedEmailAddress {
	this := DeleteAllowedEmailAddress{}
	return &this
}
...
func (o DeleteAllowedEmailAddress) MarshalJSON() ([]byte, error) {
...
func (o DeleteAllowedEmailAddress) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteAllowedEmailAddress struct {
	value *DeleteAllowedEmailAddress
	isSet bool
}

func (v NullableDeleteAllowedEmailAddress) Get() *DeleteAllowedEmailAddress {
	return v.value
}

func (v *NullableDeleteAllowedEmailAddress) Set(val *DeleteAllowedEmailAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAllowedEmailAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAllowedEmailAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAllowedEmailAddress(val *DeleteAllowedEmailAddress) *NullableDeleteAllowedEmailAddress {
	return &NullableDeleteAllowedEmailAddress{value: val, isSet: true}
}

func (v NullableDeleteAllowedEmailAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAllowedEmailAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
