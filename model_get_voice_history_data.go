...
// checks if the GetVoiceHistoryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVoiceHistoryData{}

// GetVoiceHistoryData struct for GetVoiceHistoryData
type GetVoiceHistoryData struct {
	...
	Data []VoiceMessage `json:"data,omitempty"`
}
...
func (o *GetVoiceHistoryData) SetNextPageUrlNil() {
...
func (o *GetVoiceHistoryData) SetPrevPageUrlNil() {
...
// SetData gets a reference to the given []VoiceMessage and assigns it to the Data field.
func (o *GetVoiceHistoryData) SetData(v []VoiceMessage) {
	o.Data = v
}

func (o GetVoiceHistoryData) MarshalJSON() ([]byte, error) {
...
func (o GetVoiceHistoryData) ToMap() (map[string]interface{}, error) {
...
type NullableGetVoiceHistoryData struct {
	value *GetVoiceHistoryData
	isSet bool
}

func (v NullableGetVoiceHistoryData) Get() *GetVoiceHistoryData {
	return v.value
}

func (v *NullableGetVoiceHistoryData) Set(val *GetVoiceHistoryData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVoiceHistoryData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVoiceHistoryData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVoiceHistoryData(val *GetVoiceHistoryData) *NullableGetVoiceHistoryData {
	return &NullableGetVoiceHistoryData{value: val, isSet: true}
}

func (v NullableGetVoiceHistoryData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVoiceHistoryData) UnmarshalJSON(src []byte) error {
	v.isSet = true
