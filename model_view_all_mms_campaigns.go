...
// checks if the ViewAllMmsCampaigns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllMmsCampaigns{}
...
type NullableViewAllMmsCampaigns struct {
	value *ViewAllMmsCampaigns
	isSet bool
}

func (v NullableViewAllMmsCampaigns) Get() *ViewAllMmsCampaigns {
	return v.value
}

func (v *NullableViewAllMmsCampaigns) Set(val *ViewAllMmsCampaigns) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllMmsCampaigns) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllMmsCampaigns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllMmsCampaigns(val *ViewAllMmsCampaigns) *NullableViewAllMmsCampaigns {
	return &NullableViewAllMmsCampaigns{value: val, isSet: true}
}

func (v NullableViewAllMmsCampaigns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllMmsCampaigns) UnmarshalJSON(src []byte) error {
	v.isSet = true
