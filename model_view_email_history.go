...
// checks if the ViewEmailHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewEmailHistory{}

// ViewEmailHistory struct for ViewEmailHistory
type ViewEmailHistory struct {
...
func (o ViewEmailHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewEmailHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewEmailHistory struct {
	value *ViewEmailHistory
	isSet bool
}

func (v NullableViewEmailHistory) Get() *ViewEmailHistory {
	return v.value
}

func (v *NullableViewEmailHistory) Set(val *ViewEmailHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewEmailHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewEmailHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewEmailHistory(val *ViewEmailHistory) *NullableViewEmailHistory {
	return &NullableViewEmailHistory{value: val, isSet: true}
}

func (v NullableViewEmailHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewEmailHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
