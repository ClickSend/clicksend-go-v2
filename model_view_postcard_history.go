...
// checks if the ViewPostcardHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewPostcardHistory{}

// ViewPostcardHistory struct for ViewPostcardHistory
type ViewPostcardHistory struct {
	...
	Data *ViewPostcardHistoryData `json:"data,omitempty"`
}
...
func (o *ViewPostcardHistory) GetData() ViewPostcardHistoryData {
	if o == nil || IsNil(o.Data) {
		var ret ViewPostcardHistoryData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewPostcardHistoryData and assigns it to the Data field.
func (o *ViewPostcardHistory) SetData(v ViewPostcardHistoryData) {
	o.Data = &v
}

func (o ViewPostcardHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewPostcardHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewPostcardHistory struct {
	value *ViewPostcardHistory
	isSet bool
}

func (v NullableViewPostcardHistory) Get() *ViewPostcardHistory {
	return v.value
}

func (v *NullableViewPostcardHistory) Set(val *ViewPostcardHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewPostcardHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewPostcardHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewPostcardHistory(val *ViewPostcardHistory) *NullableViewPostcardHistory {
	return &NullableViewPostcardHistory{value: val, isSet: true}
}

func (v NullableViewPostcardHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewPostcardHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
