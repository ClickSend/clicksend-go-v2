...
// checks if the CalculateMmsPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalculateMmsPrice{}

// CalculateMmsPrice struct for CalculateMmsPrice
type CalculateMmsPrice struct {
...
func (o CalculateMmsPrice) MarshalJSON() ([]byte, error) {
...
func (o CalculateMmsPrice) ToMap() (map[string]interface{}, error) {
...
type NullableCalculateMmsPrice struct {
	value *CalculateMmsPrice
	isSet bool
}

func (v NullableCalculateMmsPrice) Get() *CalculateMmsPrice {
	return v.value
}

func (v *NullableCalculateMmsPrice) Set(val *CalculateMmsPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableCalculateMmsPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableCalculateMmsPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalculateMmsPrice(val *CalculateMmsPrice) *NullableCalculateMmsPrice {
	return &NullableCalculateMmsPrice{value: val, isSet: true}
}

func (v NullableCalculateMmsPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalculateMmsPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
