...
// checks if the ForgotUsername type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForgotUsername{}

// ForgotUsername struct for ForgotUsername
...
func (o ForgotUsername) MarshalJSON() ([]byte, error) {
...
func (o ForgotUsername) ToMap() (map[string]interface{}, error) {
...
type NullableForgotUsername struct {
	value *ForgotUsername
	isSet bool
}

func (v NullableForgotUsername) Get() *ForgotUsername {
	return v.value
}

func (v *NullableForgotUsername) Set(val *ForgotUsername) {
	v.value = val
	v.isSet = true
}

func (v NullableForgotUsername) IsSet() bool {
	return v.isSet
}

func (v *NullableForgotUsername) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForgotUsername(val *ForgotUsername) *NullableForgotUsername {
	return &NullableForgotUsername{value: val, isSet: true}
}

func (v NullableForgotUsername) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForgotUsername) UnmarshalJSON(src []byte) error {
	v.isSet = true
