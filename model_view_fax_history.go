...
// checks if the ViewFaxHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewFaxHistory{}

// ViewFaxHistory struct for ViewFaxHistory
type ViewFaxHistory struct {
	...
	Data *ViewFaxHistoryData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewFaxHistoryData and assigns it to the Data field.
func (o *ViewFaxHistory) SetData(v ViewFaxHistoryData) {
	o.Data = &v
}

func (o ViewFaxHistory) MarshalJSON() ([]byte, error) {
...
func (o ViewFaxHistory) ToMap() (map[string]interface{}, error) {
...
type NullableViewFaxHistory struct {
	value *ViewFaxHistory
	isSet bool
}

func (v NullableViewFaxHistory) Get() *ViewFaxHistory {
	return v.value
}

func (v *NullableViewFaxHistory) Set(val *ViewFaxHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableViewFaxHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableViewFaxHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewFaxHistory(val *ViewFaxHistory) *NullableViewFaxHistory {
	return &NullableViewFaxHistory{value: val, isSet: true}
}

func (v NullableViewFaxHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewFaxHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
