...
// checks if the SendFax type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendFax{}

// SendFax struct for SendFax
type SendFax struct {
...
func (o SendFax) MarshalJSON() ([]byte, error) {
...
func (o SendFax) ToMap() (map[string]interface{}, error) {
...
type NullableSendFax struct {
	value *SendFax
	isSet bool
}

func (v NullableSendFax) Get() *SendFax {
	return v.value
}

func (v *NullableSendFax) Set(val *SendFax) {
	v.value = val
	v.isSet = true
}

func (v NullableSendFax) IsSet() bool {
	return v.isSet
}

func (v *NullableSendFax) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendFax(val *SendFax) *NullableSendFax {
	return &NullableSendFax{value: val, isSet: true}
}

func (v NullableSendFax) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendFax) UnmarshalJSON(src []byte) error {
	v.isSet = true
