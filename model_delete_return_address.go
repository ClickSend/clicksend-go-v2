...
// checks if the DeleteReturnAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteReturnAddress{}

// DeleteReturnAddress struct for DeleteReturnAddress
type DeleteReturnAddress struct {
...
func (o DeleteReturnAddress) MarshalJSON() ([]byte, error) {
...
func (o DeleteReturnAddress) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteReturnAddress struct {
	value *DeleteReturnAddress
	isSet bool
}

func (v NullableDeleteReturnAddress) Get() *DeleteReturnAddress {
	return v.value
}

func (v *NullableDeleteReturnAddress) Set(val *DeleteReturnAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteReturnAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteReturnAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteReturnAddress(val *DeleteReturnAddress) *NullableDeleteReturnAddress {
	return &NullableDeleteReturnAddress{value: val, isSet: true}
}

func (v NullableDeleteReturnAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteReturnAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
