...
// checks if the ViewAllEmailCampaignsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllEmailCampaignsData{}

// ViewAllEmailCampaignsData struct for ViewAllEmailCampaignsData
type ViewAllEmailCampaignsData struct {
...
func NewViewAllEmailCampaignsData() *ViewAllEmailCampaignsData {
	this := ViewAllEmailCampaignsData{}
	return &this
}
...
func (o *ViewAllEmailCampaignsData) SetNextPageUrlNil() {
...
func (o *ViewAllEmailCampaignsData) SetPrevPageUrlNil() {
...
func (o ViewAllEmailCampaignsData) MarshalJSON() ([]byte, error) {
...
func (o ViewAllEmailCampaignsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllEmailCampaignsData struct {
	value *ViewAllEmailCampaignsData
	isSet bool
}

func (v NullableViewAllEmailCampaignsData) Get() *ViewAllEmailCampaignsData {
	return v.value
}

func (v *NullableViewAllEmailCampaignsData) Set(val *ViewAllEmailCampaignsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllEmailCampaignsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllEmailCampaignsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllEmailCampaignsData(val *ViewAllEmailCampaignsData) *NullableViewAllEmailCampaignsData {
	return &NullableViewAllEmailCampaignsData{value: val, isSet: true}
}

func (v NullableViewAllEmailCampaignsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllEmailCampaignsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
