...
// checks if the CopyContactToList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyContactToList{}

// CopyContactToList struct for CopyContactToList
type CopyContactToList struct {
...
func (o CopyContactToList) MarshalJSON() ([]byte, error) {
...
func (o CopyContactToList) ToMap() (map[string]interface{}, error) {
...
type NullableCopyContactToList struct {
	value *CopyContactToList
	isSet bool
}

func (v NullableCopyContactToList) Get() *CopyContactToList {
	return v.value
}

func (v *NullableCopyContactToList) Set(val *CopyContactToList) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyContactToList) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyContactToList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyContactToList(val *CopyContactToList) *NullableCopyContactToList {
	return &NullableCopyContactToList{value: val, isSet: true}
}

func (v NullableCopyContactToList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyContactToList) UnmarshalJSON(src []byte) error {
	v.isSet = true
