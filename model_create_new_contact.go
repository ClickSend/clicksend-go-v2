...
// checks if the CreateNewContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNewContact{}

// CreateNewContact struct for CreateNewContact
...
func (o CreateNewContact) MarshalJSON() ([]byte, error) {
...
func (o CreateNewContact) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNewContact struct {
	value *CreateNewContact
	isSet bool
}

func (v NullableCreateNewContact) Get() *CreateNewContact {
	return v.value
}

func (v *NullableCreateNewContact) Set(val *CreateNewContact) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNewContact) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNewContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNewContact(val *CreateNewContact) *NullableCreateNewContact {
	return &NullableCreateNewContact{value: val, isSet: true}
}

func (v NullableCreateNewContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNewContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
