...
// checks if the ViewListContactsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewListContactsData{}

// ViewListContactsData struct for ViewListContactsData
type ViewListContactsData struct {
...
func (o *ViewListContactsData) SetNextPageUrlNil() {
...
func (o *ViewListContactsData) SetPrevPageUrlNil() {
...
func (o ViewListContactsData) MarshalJSON() ([]byte, error) {
...
func (o ViewListContactsData) ToMap() (map[string]interface{}, error) {
...
type NullableViewListContactsData struct {
	value *ViewListContactsData
	isSet bool
}

func (v NullableViewListContactsData) Get() *ViewListContactsData {
	return v.value
}

func (v *NullableViewListContactsData) Set(val *ViewListContactsData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewListContactsData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewListContactsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewListContactsData(val *ViewListContactsData) *NullableViewListContactsData {
	return &NullableViewListContactsData{value: val, isSet: true}
}

func (v NullableViewListContactsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewListContactsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
