...
// checks if the ListCountries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCountries{}

// ListCountries struct for ListCountries
type ListCountries struct {
	...
	Data []ListCountriesDataInner `json:"data,omitempty"`
}
...
func (o *ListCountries) GetData() []ListCountriesDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ListCountriesDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ListCountriesDataInner and assigns it to the Data field.
func (o *ListCountries) SetData(v []ListCountriesDataInner) {
	o.Data = v
}

func (o ListCountries) MarshalJSON() ([]byte, error) {
...
func (o ListCountries) ToMap() (map[string]interface{}, error) {
...
type NullableListCountries struct {
	value *ListCountries
	isSet bool
}

func (v NullableListCountries) Get() *ListCountries {
	return v.value
}

func (v *NullableListCountries) Set(val *ListCountries) {
	v.value = val
	v.isSet = true
}

func (v NullableListCountries) IsSet() bool {
	return v.isSet
}

func (v *NullableListCountries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCountries(val *ListCountries) *NullableListCountries {
	return &NullableListCountries{value: val, isSet: true}
}

func (v NullableListCountries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCountries) UnmarshalJSON(src []byte) error {
	v.isSet = true
