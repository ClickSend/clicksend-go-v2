...
// checks if the MarkSmsReceiptAsRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarkSmsReceiptAsRead{}

// MarkSmsReceiptAsRead struct for MarkSmsReceiptAsRead
type MarkSmsReceiptAsRead struct {
...
func (o MarkSmsReceiptAsRead) MarshalJSON() ([]byte, error) {
...
func (o MarkSmsReceiptAsRead) ToMap() (map[string]interface{}, error) {
...
type NullableMarkSmsReceiptAsRead struct {
	value *MarkSmsReceiptAsRead
	isSet bool
}

func (v NullableMarkSmsReceiptAsRead) Get() *MarkSmsReceiptAsRead {
	return v.value
}

func (v *NullableMarkSmsReceiptAsRead) Set(val *MarkSmsReceiptAsRead) {
	v.value = val
	v.isSet = true
}

func (v NullableMarkSmsReceiptAsRead) IsSet() bool {
	return v.isSet
}

func (v *NullableMarkSmsReceiptAsRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarkSmsReceiptAsRead(val *MarkSmsReceiptAsRead) *NullableMarkSmsReceiptAsRead {
	return &NullableMarkSmsReceiptAsRead{value: val, isSet: true}
}

func (v NullableMarkSmsReceiptAsRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarkSmsReceiptAsRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
