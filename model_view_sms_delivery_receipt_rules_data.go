...
// checks if the ViewSmsDeliveryReceiptRulesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsDeliveryReceiptRulesData{}

// ViewSmsDeliveryReceiptRulesData struct for ViewSmsDeliveryReceiptRulesData
type ViewSmsDeliveryReceiptRulesData struct {
...
func NewViewSmsDeliveryReceiptRulesData() *ViewSmsDeliveryReceiptRulesData {
	this := ViewSmsDeliveryReceiptRulesData{}
	return &this
}
...
func (o *ViewSmsDeliveryReceiptRulesData) SetNextPageUrlNil() {
...
func (o *ViewSmsDeliveryReceiptRulesData) SetPrevPageUrlNil() {
...
func (o ViewSmsDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsDeliveryReceiptRulesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsDeliveryReceiptRulesData struct {
	value *ViewSmsDeliveryReceiptRulesData
	isSet bool
}

func (v NullableViewSmsDeliveryReceiptRulesData) Get() *ViewSmsDeliveryReceiptRulesData {
	return v.value
}

func (v *NullableViewSmsDeliveryReceiptRulesData) Set(val *ViewSmsDeliveryReceiptRulesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsDeliveryReceiptRulesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsDeliveryReceiptRulesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsDeliveryReceiptRulesData(val *ViewSmsDeliveryReceiptRulesData) *NullableViewSmsDeliveryReceiptRulesData {
	return &NullableViewSmsDeliveryReceiptRulesData{value: val, isSet: true}
}

func (v NullableViewSmsDeliveryReceiptRulesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsDeliveryReceiptRulesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
