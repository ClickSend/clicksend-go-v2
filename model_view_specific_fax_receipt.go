...
// checks if the ViewSpecificFaxReceipt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSpecificFaxReceipt{}

// ViewSpecificFaxReceipt struct for ViewSpecificFaxReceipt
type ViewSpecificFaxReceipt struct {
...
func (o ViewSpecificFaxReceipt) MarshalJSON() ([]byte, error) {
...
func (o ViewSpecificFaxReceipt) ToMap() (map[string]interface{}, error) {
...
type NullableViewSpecificFaxReceipt struct {
	value *ViewSpecificFaxReceipt
	isSet bool
}

func (v NullableViewSpecificFaxReceipt) Get() *ViewSpecificFaxReceipt {
	return v.value
}

func (v *NullableViewSpecificFaxReceipt) Set(val *ViewSpecificFaxReceipt) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSpecificFaxReceipt) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSpecificFaxReceipt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSpecificFaxReceipt(val *ViewSpecificFaxReceipt) *NullableViewSpecificFaxReceipt {
	return &NullableViewSpecificFaxReceipt{value: val, isSet: true}
}

func (v NullableViewSpecificFaxReceipt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSpecificFaxReceipt) UnmarshalJSON(src []byte) error {
	v.isSet = true
