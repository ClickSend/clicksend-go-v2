...
// checks if the CancelScheduledPostcard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelScheduledPostcard{}

// CancelScheduledPostcard struct for CancelScheduledPostcard
type CancelScheduledPostcard struct {
...
func (o CancelScheduledPostcard) MarshalJSON() ([]byte, error) {
...
func (o CancelScheduledPostcard) ToMap() (map[string]interface{}, error) {
...
type NullableCancelScheduledPostcard struct {
	value *CancelScheduledPostcard
	isSet bool
}

func (v NullableCancelScheduledPostcard) Get() *CancelScheduledPostcard {
	return v.value
}

func (v *NullableCancelScheduledPostcard) Set(val *CancelScheduledPostcard) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelScheduledPostcard) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelScheduledPostcard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelScheduledPostcard(val *CancelScheduledPostcard) *NullableCancelScheduledPostcard {
	return &NullableCancelScheduledPostcard{value: val, isSet: true}
}

func (v NullableCancelScheduledPostcard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelScheduledPostcard) UnmarshalJSON(src []byte) error {
	v.isSet = true
