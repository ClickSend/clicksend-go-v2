...
// checks if the DeleteContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteContact{}

// DeleteContact struct for DeleteContact
...
func (o DeleteContact) MarshalJSON() ([]byte, error) {
...
func (o DeleteContact) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteContact struct {
	value *DeleteContact
	isSet bool
}

func (v NullableDeleteContact) Get() *DeleteContact {
	return v.value
}

func (v *NullableDeleteContact) Set(val *DeleteContact) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteContact) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteContact(val *DeleteContact) *NullableDeleteContact {
	return &NullableDeleteContact{value: val, isSet: true}
}

func (v NullableDeleteContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
