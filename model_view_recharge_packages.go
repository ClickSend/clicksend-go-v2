...
// checks if the ViewRechargePackages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewRechargePackages{}

// ViewRechargePackages struct for ViewRechargePackages
type ViewRechargePackages struct {
	...
	Data *ViewRechargePackagesData `json:"data,omitempty"`
}
...
func (o *ViewRechargePackages) GetData() ViewRechargePackagesData {
	if o == nil || IsNil(o.Data) {
		var ret ViewRechargePackagesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ViewRechargePackagesData and assigns it to the Data field.
func (o *ViewRechargePackages) SetData(v ViewRechargePackagesData) {
	o.Data = &v
}

func (o ViewRechargePackages) MarshalJSON() ([]byte, error) {
...
func (o ViewRechargePackages) ToMap() (map[string]interface{}, error) {
...
type NullableViewRechargePackages struct {
	value *ViewRechargePackages
	isSet bool
}

func (v NullableViewRechargePackages) Get() *ViewRechargePackages {
	return v.value
}

func (v *NullableViewRechargePackages) Set(val *ViewRechargePackages) {
	v.value = val
	v.isSet = true
}

func (v NullableViewRechargePackages) IsSet() bool {
	return v.isSet
}

func (v *NullableViewRechargePackages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewRechargePackages(val *ViewRechargePackages) *NullableViewRechargePackages {
	return &NullableViewRechargePackages{value: val, isSet: true}
}

func (v NullableViewRechargePackages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewRechargePackages) UnmarshalJSON(src []byte) error {
	v.isSet = true
