...
// checks if the ViewAllowedEmailAddressesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewAllowedEmailAddressesData{}

// ViewAllowedEmailAddressesData struct for ViewAllowedEmailAddressesData
type ViewAllowedEmailAddressesData struct {
...
func NewViewAllowedEmailAddressesData() *ViewAllowedEmailAddressesData {
	this := ViewAllowedEmailAddressesData{}
	return &this
}
...
func (o *ViewAllowedEmailAddressesData) SetNextPageUrlNil() {
...
func (o *ViewAllowedEmailAddressesData) SetPrevPageUrlNil() {
...
func (o ViewAllowedEmailAddressesData) MarshalJSON() ([]byte, error) {
...
func (o ViewAllowedEmailAddressesData) ToMap() (map[string]interface{}, error) {
...
type NullableViewAllowedEmailAddressesData struct {
	value *ViewAllowedEmailAddressesData
	isSet bool
}

func (v NullableViewAllowedEmailAddressesData) Get() *ViewAllowedEmailAddressesData {
	return v.value
}

func (v *NullableViewAllowedEmailAddressesData) Set(val *ViewAllowedEmailAddressesData) {
	v.value = val
	v.isSet = true
}

func (v NullableViewAllowedEmailAddressesData) IsSet() bool {
	return v.isSet
}

func (v *NullableViewAllowedEmailAddressesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewAllowedEmailAddressesData(val *ViewAllowedEmailAddressesData) *NullableViewAllowedEmailAddressesData {
	return &NullableViewAllowedEmailAddressesData{value: val, isSet: true}
}

func (v NullableViewAllowedEmailAddressesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewAllowedEmailAddressesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
