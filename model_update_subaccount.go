...
// checks if the UpdateSubaccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSubaccount{}
...
func (v NullableUpdateSubaccount) Get() *UpdateSubaccount {
	return v.value
}

func (v *NullableUpdateSubaccount) Set(val *UpdateSubaccount) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdateSubaccount(val *UpdateSubaccount) *NullableUpdateSubaccount {
	return &NullableUpdateSubaccount{value: val, isSet: true}
}
