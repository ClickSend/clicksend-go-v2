...
// checks if the ExportEmailHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportEmailHistory{}

// ExportEmailHistory struct for ExportEmailHistory
type ExportEmailHistory struct {
...
func (o ExportEmailHistory) MarshalJSON() ([]byte, error) {
...
func (o ExportEmailHistory) ToMap() (map[string]interface{}, error) {
...
type NullableExportEmailHistory struct {
	value *ExportEmailHistory
	isSet bool
}

func (v NullableExportEmailHistory) Get() *ExportEmailHistory {
	return v.value
}

func (v *NullableExportEmailHistory) Set(val *ExportEmailHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableExportEmailHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableExportEmailHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportEmailHistory(val *ExportEmailHistory) *NullableExportEmailHistory {
	return &NullableExportEmailHistory{value: val, isSet: true}
}

func (v NullableExportEmailHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportEmailHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
