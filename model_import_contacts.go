...
// checks if the ImportContacts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportContacts{}

// ImportContacts struct for ImportContacts
type ImportContacts struct {
	...
	Data *ImportContactsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ImportContactsData and assigns it to the Data field.
func (o *ImportContacts) SetData(v ImportContactsData) {
	o.Data = &v
}

func (o ImportContacts) MarshalJSON() ([]byte, error) {
...
func (o ImportContacts) ToMap() (map[string]interface{}, error) {
...
type NullableImportContacts struct {
	value *ImportContacts
	isSet bool
}

func (v NullableImportContacts) Get() *ImportContacts {
	return v.value
}

func (v *NullableImportContacts) Set(val *ImportContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableImportContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableImportContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportContacts(val *ImportContacts) *NullableImportContacts {
	return &NullableImportContacts{value: val, isSet: true}
}

func (v NullableImportContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
