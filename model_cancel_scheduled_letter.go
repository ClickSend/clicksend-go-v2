...
// checks if the CancelScheduledLetter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelScheduledLetter{}

// CancelScheduledLetter struct for CancelScheduledLetter
type CancelScheduledLetter struct {
...
func (o CancelScheduledLetter) MarshalJSON() ([]byte, error) {
...
func (o CancelScheduledLetter) ToMap() (map[string]interface{}, error) {
...
type NullableCancelScheduledLetter struct {
	value *CancelScheduledLetter
	isSet bool
}

func (v NullableCancelScheduledLetter) Get() *CancelScheduledLetter {
	return v.value
}

func (v *NullableCancelScheduledLetter) Set(val *CancelScheduledLetter) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelScheduledLetter) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelScheduledLetter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelScheduledLetter(val *CancelScheduledLetter) *NullableCancelScheduledLetter {
	return &NullableCancelScheduledLetter{value: val, isSet: true}
}

func (v NullableCancelScheduledLetter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelScheduledLetter) UnmarshalJSON(src []byte) error {
	v.isSet = true
