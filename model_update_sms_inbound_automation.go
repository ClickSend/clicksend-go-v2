...
// checks if the UpdateSmsInboundAutomation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSmsInboundAutomation{}

// UpdateSmsInboundAutomation struct for UpdateSmsInboundAutomation
type UpdateSmsInboundAutomation struct {
...
func NewUpdateSmsInboundAutomation() *UpdateSmsInboundAutomation {
	this := UpdateSmsInboundAutomation{}
	return &this
}
...
func (o UpdateSmsInboundAutomation) MarshalJSON() ([]byte, error) {
...
func (o UpdateSmsInboundAutomation) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSmsInboundAutomation struct {
	value *UpdateSmsInboundAutomation
	isSet bool
}

func (v NullableUpdateSmsInboundAutomation) Get() *UpdateSmsInboundAutomation {
	return v.value
}

func (v *NullableUpdateSmsInboundAutomation) Set(val *UpdateSmsInboundAutomation) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSmsInboundAutomation) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSmsInboundAutomation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSmsInboundAutomation(val *UpdateSmsInboundAutomation) *NullableUpdateSmsInboundAutomation {
	return &NullableUpdateSmsInboundAutomation{value: val, isSet: true}
}

func (v NullableUpdateSmsInboundAutomation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSmsInboundAutomation) UnmarshalJSON(src []byte) error {
	v.isSet = true
