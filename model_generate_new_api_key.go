...
// checks if the GenerateNewApiKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateNewApiKey{}

// GenerateNewApiKey struct for GenerateNewApiKey
type GenerateNewApiKey struct {
	...
	Data *GenerateNewApiKeyData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given GenerateNewApiKeyData and assigns it to the Data field.
func (o *GenerateNewApiKey) SetData(v GenerateNewApiKeyData) {
	o.Data = &v
}

func (o GenerateNewApiKey) MarshalJSON() ([]byte, error) {
...
func (o GenerateNewApiKey) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateNewApiKey struct {
	value *GenerateNewApiKey
	isSet bool
}

func (v NullableGenerateNewApiKey) Get() *GenerateNewApiKey {
	return v.value
}

func (v *NullableGenerateNewApiKey) Set(val *GenerateNewApiKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateNewApiKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateNewApiKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateNewApiKey(val *GenerateNewApiKey) *NullableGenerateNewApiKey {
	return &NullableGenerateNewApiKey{value: val, isSet: true}
}

func (v NullableGenerateNewApiKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateNewApiKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
