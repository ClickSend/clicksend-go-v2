...
// checks if the ViewSmsReceipts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSmsReceipts{}

// ViewSmsReceipts struct for ViewSmsReceipts
type ViewSmsReceipts struct {
	...
	Data *ViewSmsReceiptsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ViewSmsReceiptsData and assigns it to the Data field.
func (o *ViewSmsReceipts) SetData(v ViewSmsReceiptsData) {
	o.Data = &v
}

func (o ViewSmsReceipts) MarshalJSON() ([]byte, error) {
...
func (o ViewSmsReceipts) ToMap() (map[string]interface{}, error) {
...
type NullableViewSmsReceipts struct {
	value *ViewSmsReceipts
	isSet bool
}

func (v NullableViewSmsReceipts) Get() *ViewSmsReceipts {
	return v.value
}

func (v *NullableViewSmsReceipts) Set(val *ViewSmsReceipts) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSmsReceipts) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSmsReceipts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSmsReceipts(val *ViewSmsReceipts) *NullableViewSmsReceipts {
	return &NullableViewSmsReceipts{value: val, isSet: true}
}

func (v NullableViewSmsReceipts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSmsReceipts) UnmarshalJSON(src []byte) error {
	v.isSet = true
